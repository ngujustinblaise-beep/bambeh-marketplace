...
// --- 3b. BAMBEH SARL â€” CamPay & Cart Integration -----------------------------
...
// --- 5b. LANGUAGE CONTEXT (inline â€” no external file dependency) --------------
...
const LANG_STRINGS: Record<LangCode, Record<string, string>> = {
  en: {
    ...
    closed:"\u{1F512} Closed â€” Deadline passed", closingSoon:"\u{23F0} Closing soon",
  ...
  fr: {
    ...
    clearFilters:"\u{1F5D1}\u{FE0F} Effacer tous les filtres", jobType:"Type d'emploi", region:"RÃ©gion",
    jobsFound:"offres trouvÃ©es", newestFirst:"plus rÃ©cent d'abord",
    refresh:"\u{1F504} Actualiser", noJobs:"Aucune offre publiÃ©e",
    noJobsHint:"Soyez le premier Ã  publier une offre !",
    noMatch:"Aucune offre ne correspond", clearAll:"Effacer les filtres",
    applyNow:"\u{1F4DD} Postuler maintenant", views:"vues", negotiable:"NÃ©gociable",
    ...
    closed:"? FermÃ© â€” DÃ©lai dÃ©passÃ©", closingSoon:"? Ferme bientÃ´t",
    ...
    applyEmail:"Postuler par email", applied:"Candidature envoyÃ©e ?",
    ...
    applyCallOpt:"\u{1F4DE} Appel tÃ©lÃ©phonique", applyEmailOpt:"\u{2709}\u{FE0F} Email",
    ...
    donation:"Don", securePayment:"Paiement sÃ©curisÃ©", processingPayment:"Traitement du paiement",
    viewWallet:"Voir le Portefeuille", added:"ajoutÃ© Ã  votre portefeuille", buyCoins:"Acheter des PiÃ¨ces Zerm",
  },
  pidgin: {
    ...
    ar: {
    home:"Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠØ©", jobs:"Ø§Ù„ÙˆØ¸Ø§Ø¦Ù", marketplace:"Ø§Ù„Ø³ÙˆÙ‚",
    services:"Ø§Ù„Ø®Ø¯Ù…Ø§Øª", rentals:"Ø§Ù„Ø¥ÙŠØ¬Ø§Ø±Ø§Øª", vehicles:"Ø§Ù„Ù…Ø±ÙƒØ¨Ø§Øª",
    exchange:"Ø§Ù„Ù…Ù‚Ø§ÙŠØ¶Ø©", community:"Ø§Ù„Ù…Ø¬ØªÙ…Ø¹", sell:"Ø¨ÙŠØ¹",
    buy:"Ø´Ø±Ø§Ø¡", search:"Ø¨Ø­Ø«", login:"ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„",
    register:"Ø¥Ù†Ø´Ø§Ø¡ Ø­Ø³Ø§Ø¨", logout:"ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø®Ø±ÙˆØ¬", settings:"Ø§Ù„Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª",
    favorites:"Ø§Ù„Ù…ÙØ¶Ù„Ø©", orders:"Ø§Ù„Ø·Ù„Ø¨Ø§Øª", back:"Ø±Ø¬ÙˆØ¹",
    cancel:"Ø¥Ù„ØºØ§Ø¡", save:"Ø­ÙØ¸", loading:"Ø¬Ø§Ø±Ù Ø§Ù„ØªØ­Ù…ÙŠÙ„â€¦",
    error:"Ø­Ø¯Ø« Ø®Ø·Ø£ Ù…Ø§. ÙŠØ±Ø¬Ù‰ Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ø±Ø© Ø£Ø®Ø±Ù‰.", retry:"Ø¥Ø¹Ø§Ø¯Ø© Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø©", seeAll:"Ø¹Ø±Ø¶ Ø§Ù„ÙƒÙ„",
    tryAgain:"Ø­Ø§ÙˆÙ„ Ù…Ø¬Ø¯Ø¯Ù‹Ø§", share:"Ù…Ø´Ø§Ø±ÙƒØ©", copyLink:"ØªÙ… Ù†Ø³Ø® Ø§Ù„Ø±Ø§Ø¨Ø·!",
    jobsTitle:"Ø§Ø¨Ø­Ø« Ø¹Ù† ÙˆØ¸Ø§Ø¦Ù", postJob:"+ Ù†Ø´Ø± ÙˆØ¸ÙŠÙØ©", jobSearchPlaceholder:"Ø§Ø¨Ø­Ø« Ø¹Ù† ÙˆØ¸Ø§Ø¦Ù Ø£Ùˆ Ø´Ø±ÙƒØ§Øªâ€¦",
    opportunities:"ÙØ±Øµ ÙÙŠ Ø¬Ù…ÙŠØ¹ Ø£Ù†Ø­Ø§Ø¡ Ø§Ù„ÙƒØ§Ù…ÙŠØ±ÙˆÙ†", filters:"Ø§Ù„ØªØµÙÙŠØ©", mostRecent:"Ø§Ù„Ø£Ø­Ø¯Ø«",
    clearFilters:"Ù…Ø³Ø­ ÙƒÙ„ Ø¹ÙˆØ§Ù…Ù„ Ø§Ù„ØªØµÙÙŠØ©", jobType:"Ù†ÙˆØ¹ Ø§Ù„ÙˆØ¸ÙŠÙØ©", region:"Ø§Ù„Ù…Ù†Ø·Ù‚Ø©",
    jobsFound:"ÙˆØ¸ÙŠÙØ© Ù…ÙˆØ¬ÙˆØ¯Ø©", newestFirst:"Ø§Ù„Ø£Ø­Ø¯Ø« Ø£ÙˆÙ„Ø§Ù‹", refresh:"ØªØ­Ø¯ÙŠØ«",
    noJobs:"Ù„Ø§ ØªÙˆØ¬Ø¯ ÙˆØ¸Ø§Ø¦Ù Ù…Ù†Ø´ÙˆØ±Ø© Ø¨Ø¹Ø¯", noJobsHint:"ÙƒÙ† Ø£ÙˆÙ„ Ù…Ù† ÙŠÙ†Ø´Ø± ÙØ±ØµØ© Ø¹Ù…Ù„!", noMatch:"Ù„Ø§ ØªÙˆØ¬Ø¯ ÙˆØ¸Ø§Ø¦Ù ØªØ·Ø§Ø¨Ù‚ Ø¹ÙˆØ§Ù…Ù„ Ø§Ù„ØªØµÙÙŠØ©",
    clearAll:"Ù…Ø³Ø­ Ø§Ù„ÙƒÙ„", applyNow:"ØªÙ‚Ø¯Ù‘Ù… Ø§Ù„Ø¢Ù†", views:"Ù…Ø´Ø§Ù‡Ø¯Ø§Øª",
    negotiable:"Ù‚Ø§Ø¨Ù„ Ù„Ù„ØªÙØ§ÙˆØ¶", salaryNotSpec:"Ø§Ù„Ø±Ø§ØªØ© ØºÙŠØ± Ù…Ø­Ø¯Ø¯", deadline:"Ø§Ù„Ù…ÙˆØ¹Ø¯ Ø§Ù„Ù†Ù‡Ø§Ø¦ÙŠ",
    remote:"Ø¹Ù† Ø¨ÙØ¹Ø¯", jobError:"ØªØ¹Ø°Ù‘Ø± ØªØ­Ù…ÙŠÙ„ Ø§Ù„ÙˆØ¸Ø§Ø¦Ù. ØªØ­Ù‚Ù‚ Ù…Ù† Ø§ØªØµØ§Ù„Ùƒ.", salary:"Ø§Ù„Ø±Ø§ØªØ© Ø§Ù„Ø´Ù‡Ø±ÙŠ",
    allJobs:"ÙƒÙ„ Ø§Ù„ÙˆØ¸Ø§Ø¦Ù", opportunity:"Ø±Ù†ØµØ©", opportunitiesPlural:"ÙØ±Øµ",
    noJobsCategory:"Ù„Ø§ ØªÙˆØ¬Ø¯ ÙˆØ¸Ø§Ø¦Ù Ù…Ù†Ø´ÙˆØ±Ø© Ø¨Ø¹Ø¯", checkBack:"Ø¹ÙØ¯ Ù‚Ø±ÙŠØ¨Ù‹Ø§ Ø£Ùˆ Ø§Ù†Ø´Ø± ÙˆØ§Ø­Ø¯Ø© Ø¨Ù†ÙØ³Ùƒ!", viewApply:"Ø¹Ø±Ø¶ ÙˆØªÙ‚Ø¯ÙŠÙ…",
    loadMore:"ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ù…Ø²ÙŠØ¯ Ù…Ù† Ø§Ù„ÙˆØ¸Ø§Ø¦Ù", closed:"Ù…ØºÙ„Ù‚ â€” Ø§Ù†ØªÙ‡Ù‰ Ø§Ù„Ù…ÙˆØ¹Ø¯ Ø§Ù„Ù†Ù‡Ø§Ø¦ÙŠ", closingSoon:"ÙŠÙØºÙ„Ù‚ Ù‚Ø±ÙŠØ¨Ù‹Ø§",
    today:"Ø§Ù„ÙŠÙˆÙ…!", dLeft:"ÙŠÙˆÙ… Ù…ØªØ¨Ù‚Ù", jobNotFound:"Ø§Ù„ÙˆØ¸ÙŠÙØ© ØºÙŠØ± Ù…ÙˆØ¬ÙˆØ¯Ø©",
    jobLoading:"Ø¬Ø§Ø±Ù ØªØ­Ù…ÙŠÙ„ ØªÙØ§ØµÙŠÙ„ Ø§Ù„ÙˆØ¸ÙŠÙØ©â€¦", jobDescription:"ÙˆØµÙ Ø§Ù„ÙˆØ¸ÙŠÙØ©", requirements:"Ø§Ù„Ù…ØªØ·Ù„Ø¨Ø§Øª ÙˆØ§Ù„Ù…Ù‡Ø§Ø±Ø§Øª",
    benefits:"Ø§Ù„Ù…Ø²Ø§ÙŠØ§ ÙˆØ§Ù„Ø§Ù…ØªÙŠØ§Ø²Ø§Øª", jobApplyNow:"ØªÙ‚Ø¯Ù‘Ù… Ø§Ù„Ø¢Ù†", applyWhatsApp:"Ø§Ù„ØªÙ‚Ø¯ÙŠÙ… Ø¹Ø¨Ø± ÙˆØ§ØªØ³Ø§Ø¨",
    applyCall:"Ø§ØªØµÙ„ Ù„Ù„ØªÙ‚Ø¯ÙŠÙ…", applyEmail:"Ø§Ù„ØªÙ‚Ø¯ÙŠÙ… Ø¹Ø¨Ø± Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ", applied:"ØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨",
    applying:"Ø¬Ø§Ø±Ù Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø·Ù„Ø¨â€¦", alreadyApplied:"Ù„Ù‚Ø¯ ØªÙ‚Ø¯Ù‘Ù…Øª Ù„Ù‡Ø°Ù‡ Ø§Ù„ÙˆØ¸ÙŠÙØ© Ø¨Ø§Ù„ÙØ¹Ù„", expired:"Ø§Ù†ØªÙ‡Øª ØµÙ„Ø§Ø­ÙŠØ© Ù‡Ø°Ù‡ Ø§Ù„ÙˆØ¸ÙŠÙØ©",
    deadline2:"Ø§Ù„Ù…ÙˆØ¹Ø¯ Ø§Ù„Ù†Ù‡Ø§Ø¦ÙŠ Ù„Ù„ØªÙ‚Ø¯ÙŠÙ…", candidates:"Ù…ØªÙ‚Ø¯Ù…ÙˆÙ†", views2:"Ù…Ø´Ø§Ù‡Ø¯Ø§Øª",
    published:"Ù†ÙØ´Ø±", saved:"Ù…Ø­ÙÙˆØ¸", unsaved:"Ø­ÙØ¸",
    loginToApply:"Ø³Ø¬Ù‘Ù„ Ø§Ù„Ø¯Ø®ÙˆÙ„ Ù„Ù„ØªÙ‚Ø¯ÙŠÙ…", postJobTitle:"Ù†Ø´Ø± ÙˆØ¸ÙŠÙØ©", postJobSubtitle:"Ø§Ø¹Ø«Ø± Ø¹Ù„Ù‰ Ø§Ù„Ù…ÙˆÙ‡Ø¨Ø© Ø§Ù„Ù…Ù†Ø§Ø³Ø¨Ø© ÙÙŠ Ø§Ù„ÙƒØ§Ù…ÙŠØ±ÙˆÙ†",
    jobTitle:"Ø§Ù„Ù…Ø³Ù…Ù‰ Ø§Ù„ÙˆØ¸ÙŠÙÙŠ *", jobTitlePh:"Ù…Ø«Ø§Ù„: Ù…Ù‡Ù†Ø¯Ø³ Ø¨Ø±Ù…Ø¬ÙŠØ§Øª Ø£ÙˆÙ„", company:"Ø§Ù„Ø´Ø±ÙƒØ© / Ø§Ù„Ù…Ø¤Ø³Ø³Ø©",
    companyPh:"Ø§Ø³Ù… Ø´Ø±ÙƒØªÙƒ", jobCategory:"ÙØ¦Ø© Ø§Ù„ÙˆØ¸ÙŠÙØ© *", employmentType:"Ù†ÙˆØ¹ Ø§Ù„ØªÙˆØ¸ÙŠÙ *",
    experienceLevel:"Ù…Ø³ØªÙˆÙ‰ Ø§Ù„Ø®Ø¨Ø±Ø© *", cityLocation:"Ø§Ù„Ù…Ø¯ÙŠÙ†Ø© / Ø§Ù„Ù…ÙˆÙ‚Ø¹ *", cityPh:"Ù…Ø«Ø§Ù„: Ø¯ÙˆØ§Ù„Ø§ØŒ ÙŠØ§ÙˆÙ†Ø¯ÙŠâ€¦",
    regionLabel:"Ø§Ù„Ù…Ù†Ø·Ù‚Ø©", isRemote:"Ø§Ù„Ø¹Ù…Ù„ Ø¹Ù† Ø¨ÙØ¹Ø¯ Ù…ØªØ§Ø­", salaryMin:"Ø§Ù„Ø­Ø¯ Ø§Ù„Ø£Ø¯Ù†Ù‰ Ù„Ù„Ø±Ø§ØªØ¨ (ÙØ±Ù†Ùƒ/Ø´Ù‡Ø±)",
    salaryMax:"Ø§Ù„Ø­Ø¯ Ø§Ù„Ø£Ù‚ØµÙ‰ Ù„Ù„Ø±Ø§ØªØ¨ (ÙØ±Ù†Ùƒ/Ø´Ù‡Ø±)", salaryPh:"Ù…Ø«Ø§Ù„: 150000", salaryNegotiable:"Ø§Ù„Ø±Ø§ØªØ¨ Ù‚Ø§Ø¨Ù„ Ù„Ù„ØªÙØ§ÙˆØ¶",
    applicationDeadline:"Ø§Ù„Ù…ÙˆØ¹Ø¯ Ø§Ù„Ù†Ù‡Ø§Ø¦ÙŠ Ù„Ù„ØªÙ‚Ø¯ÙŠÙ…", jobDescription2:"ÙˆØµÙ Ø§Ù„ÙˆØ¸ÙŠÙØ© *", jobDescPh:"ØµÙÙ Ø§Ù„Ø¯ÙˆØ± ÙˆØ§Ù„Ù…Ù‡Ø§Ø±Ø§Øª ÙˆØ§Ù„Ø®Ø¨Ø±Ø© Ø§Ù„Ù…Ø·Ù„ÙˆØ¨Ø©â€¦", requirementsPh:"Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ", benefitsLabel:"Ø§Ù„Ù…Ø²Ø§ÙŠØ§ ÙˆØ§Ù„Ø§Ù…ØªÙŠØ§Ø²Ø§Øª", benefitsPh:"ØªØ£Ù…ÙŠÙ† ØµØ­ÙŠØŒ Ø¨Ø¯Ù„ Ù†Ù‚Ù„ØŒ Ù…ÙƒØ§ÙØ¢Øªâ€¦",
    tagsLabel:"Ø§Ù„Ù…Ù‡Ø§Ø±Ø§Øª / Ø§Ù„ÙˆØ³ÙˆÙ… (Ù…ÙØµÙˆÙ„Ø© Ø¨ÙØ§ØµÙ„Ø©)", tagsPh:"ReactØŒ Node.jsØŒ ØªØ³ÙˆÙŠÙ‚â€¦", howApply:"ÙƒÙŠÙ ÙŠØªÙ‚Ø¯Ù‘Ù… Ø§Ù„Ù…Ø±Ø´Ø­ÙˆÙ†ØŸ",
    applyInApp:"Ø¹Ø¨Ø± Ù…Ù†ØµØ© Ø¨Ø§Ù…Ø¨ÙŠÙ‡", applyWhatsAppOpt:"ÙˆØ§ØªØ³Ø§Ø¨", applyCallOpt:"Ù…ÙƒØ§Ù„Ù…Ø© Ù‡Ø§ØªÙÙŠØ©",
    applyEmailOpt:"Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ", applyContactPh:"Ø£Ø¯Ø®Ù„ Ø±Ù‚Ù… Ø§Ù„Ù‡Ø§ØªÙ Ø£Ùˆ Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ Ù„Ù„ØªÙ‚Ø¯ÙŠÙ…", publishing:"Ø¬Ø§Ø±Ù Ù†Ø´Ø± ÙˆØ¸ÙŠÙØªÙƒâ€¦",
    jobPosted:"ØªÙ… Ù†Ø´Ø± Ø§Ù„ÙˆØ¸ÙŠÙØ© Ø¨Ù†Ø¬Ø§Ø­!", publishJob:"Ù†Ø´Ø± Ø§Ù„ÙˆØ¸ÙŠÙØ©", fillRequired:"ÙŠØ±Ø¬Ù‰ Ù…Ù„Ø¡ Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø­Ù‚ÙˆÙ„ Ø§Ù„Ù…Ø·Ù„ÙˆØ¨Ø© (*)",
    loginRequired:"ÙŠØ¬Ø¨ ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„ Ù„Ù†Ø´Ø± ÙˆØ¸ÙŠÙØ©", companyLogoLabel:"Ø´Ø¹Ø§Ø± Ø§Ù„Ø´Ø±ÙƒØ©", chooseImage:"Ø§Ø®ØªØ± ØµÙˆØ±Ø©",
    catAll:"Ø§Ù„ÙƒÙ„", catVegetables:"Ø®Ø¶Ø±ÙˆØ§Øª", catFruits:"ÖªÙˆØ§ÙƒÙ‡",
    catTubers:"Ø¯Ø±Ù†Ø§Øª", catGrains:"Ø­Ø¨ÙˆØ¨", catLegumes:"Ø¨Ù‚ÙˆÙ„ÙŠØ§Øª",
    catHerbs:"Ø£Ø¹Ø´Ø§Ø¨", catDairy:"Ù…Ù†ØªØ¬Ø§Øª Ø§Ù„Ø£Ù„Ø¨Ø§Ù†", cartEmpty:"Ø³Ù„Ø© Ø§Ù„ØªØ³ÙˆÙ‚ ÙØ§Ø±ØºØ©",
    continueShopping:"Ù…ØªØ§Ø¨Ø¹Ø© Ø§Ù„ØªØ³ÙˆÙ‚", checkout:"Ø¥ØªÙ…Ø§Ù… Ø§Ù„Ø´Ø±Ø§Ø¡", subtotal:"Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹ Ø§Ù„ÙØ±Ø¹ÙŠ",
    fee1pct:"Ø±Ø³ÙˆÙ… Ø¨Ø§Ù…Ø¨ÙŠÙ‡ (1%)", total:"Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹", payWithMoMo:"Ø§Ù„Ø¯ÙØ¹ Ø¹Ø¨Ø± MTN MoMo",
    payWithOrange:"Ø§Ù„Ø¯ÙØ¹ Ø¹Ø¨Ø± Orange Money", payNow:"Ø§Ø¯ÙØ¹ Ø§Ù„Ø¢Ù†", paymentPending:"Ø§Ù„Ø¯ÙØ¹ Ù‚ÙŠØ¯ Ø§Ù„Ø§Ù†ØªØ¸Ø§Ø±",
    paymentSuccess:"ØªÙ… Ø§Ù„Ø¯ÙØ¹ Ø¨Ù†Ø¬Ø§Ø­!", paymentFailed:"ÙØ´Ù„ Ø§Ù„Ø¯ÙØ¹", donation:"ØªØ¨Ø±Ø¹",
    securePayment:"Ø¯ÙØ¹ Ø¢Ù…Ù†", processingPayment:"Ø¬Ø§Ø±Ù Ù…Ø¹Ø§Ù„Ø¬Ø© Ø§Ù„Ø¯ÙØ¹", viewWallet:"Ø¹Ø±Ø¶ Ø§Ù„Ù…Ø­ÙØ¸Ø©",
    added:"Ø£ÙØ¶ÙŠÙ Ø¥Ù„Ù‰ Ù…Ø­ÙØ¸ØªÙƒ", buyCoins:"Ø´Ø±Ø§Ø¡ Ø¹Ù…Ù„Ø§Øª Ø²Ø±Ù…",
  },
  ff: {
    home:"Jeyeendi", jobs:"Liggaade", marketplace:"Maare", services:"É—alÉ—e",
    rentals:"Hireeli", vehicles:"Ottooji", exchange:"YoÆ´taari", community:"Ã‘iÆ´Æ´e",
    ...
    save:"Dannee", loading:"E nder loodiâ€¦", error:"Huunde wa??i. ?ettoo.",
    retry:"?ettoo", seeAll:"Hol fof", tryAgain:"E??oo yeeso",
    share:"Siiwtindiraa", copyLink:"Ã‘olndi ja??aama!",
    ...
    applyNow:"?? DaÃ± Golle", views:"yiylaama", negotiable:"Naggi",
    ...
    viewApply:"Yii & DaÃ± ?", loadMore:"Nanngin Golleli",
    closed:"? Uddii", closingSoon:"? ?ennoo see?a",
    today:"Hannde!", dLeft:"bal?e",
    jobNotFound:"Golle he?aani", jobLoading:"Nannginiiâ€¦",
    ...
    applyEmail:"Imeel ngam DaÃ±de", applied:"Jokkunde nootii ?",
    ...
    jobDescription2:"Ja?tugol Golle *", jobDescPh:"Ja?tu golle ndeeâ€¦",
    requirementsPh:"Ja?tu ko he?etee, ?em?eâ€¦",
    benefitsLabel:"Nafaaji", benefitsPh:"Laamu cellal, nju??udiâ€¦",
    tagsLabel:"?em?e (tippu?e e tiindol)", tagsPh:"React, Node.jsâ€¦",
    ...
    payNow:"Ã‘ammbu ?oo", paymentPending:"E Yo?deâ€¦",
...
// --- 6. Layouts (Eager â€” used on nearly every route) -------------------------
