...
const LANG_STRINGS: Record<LangCode, Record<string, string>> = {
  ...
  pidgin: {
    ...
    ar: {
    home:"الرئيسية", jobs:"الوظائف", marketplace:"السوق",
    services:"الخدمات", rentals:"الإيجارات", vehicles:"المركبات",
    exchange:"المقايضة", community:"المجتمع", sell:"بيع",
    buy:"شراء", search:"بحث", login:"تسجيل الدخول",
    register:"إنشاء حساب", logout:"تسجيل الخروج", settings:"الإعدادات",
    favorites:"المفضلة", orders:"الطلبات", back:"رجوع",
    cancel:"إلغاء", save:"حفظ", loading:"جارٍ التحميل…",
    error:"حدث خطأ ما. يرجى المحاولة مرة أخرى.", retry:"إعادة المحاولة", seeAll:"عرض الكل",
    tryAgain:"حاول مجددًا", share:"مشاركة", copyLink:"تم نسخ الرابط!",
    jobsTitle:"ابحث عن وظائف", postJob:"+ نشر وظيفة", jobSearchPlaceholder:"ابحث عن وظائف أو شركات…",
    opportunities:"فرص في جميع أنحاء الكاميرون", filters:"التصفية", mostRecent:"الأحدث",
    clearFilters:"مسح كل عوامل التصفية", jobType:"نوع الوظيفة", region:"المنطقة",
    ...
    jobLoading:"جارٍ تحميل تفاصيل الوظيفة…", jobDescription:"وصف الوظيفة", requirements:"المتطلبات والمهارات",
    benefits:"المزايا والامتيازات", jobApplyNow:"تقدّم الآن", applyWhatsApp:"التقديم عبر واتساب",
    applyCall:"اتصل للتقديم", applyEmail:"التقديم عبر البريد الإلكتروني", applied:"تم إرسال الطلب",
    applying:"جارٍ إرسال الطلب…", alreadyApplied:"لقد تقدّمت لهذه الوظيفة بالفعل", expired:"انتهت صلاحية هذه الوظيفة",
    deadline2:"الموعد النهائي للتقديم", candidates:"متقدمون", views2:"مشاهدات",
    published:"نُشر", saved:"محفوظ", unsaved:"حفظ",
    loginToApply:"سجّل الدخول للتقديم", postJobTitle:"نشر وظيفة", postJobSubtitle:"اعثر على الموهبة المناسبة في الكاميرون",
    jobTitle:"المسمى الوظيفي *", jobTitlePh:"مثال: مهندس برمجيات أول", company:"الشركة / المؤسسة",
    companyPh:"اسم شركتك", jobCategory:"فئة الوظيفة *", employmentType:"نوع التوظيف *",
    experienceLevel:"مستوى الخبرة *", cityLocation:"المدينة / الموقع *", cityPh:"مثال: دوالا، ياوندي…",
    regionLabel:"المنطقة", isRemote:"العمل عن بُعد متاح", salaryMin:"الحد الأدنى للراتب (فرنك/شهر)",
    salaryMax:"الحد الأقصى للراتب (فرنك/شهر)", salaryPh:"مثال: 150000", salaryNegotiable:"الراتب قابل للتفاوض",
    applicationDeadline:"الموعد النهائي للتقديم", jobDescription2:"وصف الوظيفة *", jobDescPh:"صِف الدور والمسؤوليات وكيف يبدو يوم العمل المعتاد…",
    requirementsPh:"اذكر المؤهلات والمهارات والخبرة المطلوبة…", benefitsLabel:"المزايا والامتيازات", benefitsPh:"تأمين صحي، بدل نقل، مكافآت…",
    tagsLabel:"المهارات / الوسوم (مفصولة بفاصلة)", tagsPh:"React، Node.js، تسويق…", howApply:"كيف يتقدّم المرشحون؟",
    applyInApp:"عبر منصة بامبيه", applyWhatsAppOpt:"واتساب", applyCallOpt:"مكالمة هاتفية",
    ...
    fee1pct:"رسوم بامبيه (1%)", total:"المجموع", payWithMoMo:"الدفع عبر MTN MoMo",
    payWithOrange:"الدفع عبر Orange Money", payNow:"ادفع الآن", paymentPending:"الدفع قيد الانتظار",
    paymentSuccess:"تم الدفع بنجاح!", paymentFailed:"فشل الدفع", donation:"تبرع",
    securePayment:"دفع آمن", processingPayment:"جارٍ معالجة الدفع", viewWallet:"عرض المحفظة",
