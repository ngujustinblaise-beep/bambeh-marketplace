...
const LANG_STRINGS: Record<LangCode, Record<string, string>> = {
  ...
  pidgin: {
    ...
    applicationDeadline:"الموعد النهائي للتقديم", jobDescription2:"وصف الوظيفة *", jobDescPh:"صِف الدور والمهارات والخبرة المطلوبة…", requirementsPh:"الإلكتروني", benefitsLabel:"المزايا والامتيازات", benefitsPh:"تأمين صحي، بدل نقل، مكافآت…",
