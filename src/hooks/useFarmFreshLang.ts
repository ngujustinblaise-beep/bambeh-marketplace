...
export const T = {
  ...
  buyDirect: {
    ...
    ar:       "ðŸŒ¿ Ø§Ø´ØªØ±Ù Ù…Ø¨Ø§Ø´Ø±Ø© Ù…Ù† Ø§Ù„Ù…Ø²Ø§Ø±Ø¹ÙŠÙ†",
  ...
  buyDirectSub: {
    ...
    ar:       "Ù…Ù†ØªØ¬Ø§Øª Ø·Ø§Ø²Ø¬Ø©ØŒ Ø£Ø³Ø¹Ø§Ø± Ø¹Ø§Ø¯Ù„Ø©. Ù…Ø±Ø¦ÙŠ Ù„Ù„Ù…Ø´ØªØ±ÙŠÙ† ÙÙŠ Ø¬Ù…ÙŠØ¹ Ø£Ù†Ø­Ø§Ø¡ Ø§Ù„Ø¹Ø§Ù„Ù….",
  ...
  joinGroup: {
    ...
    ar:       "Ø§Ù†Ø¶Ù… Ù„Ù„Ø´Ø±Ø§Ø¡ Ø§Ù„Ø¬Ù…Ø§Ø¹ÙŠ â€” ÙˆÙÙ‘Ø± Ø£ÙƒØ«Ø±",
  ...
  loading: {
    ...
    ar:       "Ø¬Ø§Ø±Ù ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ù…Ù†ØªØ¬Ø§Øª Ø§Ù„Ø·Ø§Ø²Ø¬Ø©â€¦",
  ...
  noProduceFound: {
    ...
    ar:       "Ù„Ù… ÙŠÙØ¹Ø«Ø± Ø¹Ù„Ù‰ Ù…Ù†ØªØ¬Ø§Øª",
  ...
  showingSamples: {
    ...
    ar:       (n: number) => `Ø¹Ø±Ø¶ ${n} Ø¹Ù†Ø§ØµØ± Ù†Ù…ÙˆØ°Ø¬ÙŠØ© â€” ÙƒÙ† Ø£ÙˆÙ„ Ù…Ù† ÙŠØ¶ÙŠÙ Ù…Ù†ØªØ¬Ø§Ù‹ Ø­Ù‚ÙŠÙ‚ÙŠØ§Ù‹!`,
  ...
  groupBuyingAd: {
    ...
    ar:       { title: "Ø´Ø±Ø§Ø¡ Ø¬Ù…Ø§Ø¹ÙŠ", subtitle: "Ø§Ø´ØªØ±Ù Ù…Ø¹Ø§Ù‹ØŒ ÙˆÙÙ‘Ø± Ø£ÙƒØ«Ø±", cta: "Ø§Ù†Ø¶Ù…" },
  ...
  sellProduceAd: {
    ...
    ar:       { title: "Ø¨ÙØ¹ Ù…Ù†ØªØ¬Ø§ØªÙƒ", subtitle: "ØªÙˆØ§ØµÙ„ Ù…Ø¹ Ø§Ù„Ù…Ø´ØªØ±ÙŠÙ† ÙÙŠ Ø§Ù„ÙƒØ§Ù…ÙŠØ±ÙˆÙ†", cta: "Ø£Ø¶Ù Ø§Ù„Ø¢Ù†" },
  ...
  catFruits:     { en:"Fruits",     fr:"Fruits",    pidgin:"Fruits",     ar:"ÙÙˆØ§ÙƒÙ‡",       fulfulde:"Biccol"      },
  ...
  joinGroupBuySub: { en:"Pool orders with other buyers and save more", fr:"Commandez ensemble et Ã©conomisez davantage", pidgin:"Join body, buy together, save plenty money", ar:"Ø§Ø¬Ù…Ø¹ Ø§Ù„Ø·Ù„Ø¨Ø§Øª Ù…Ø¹ Ù…Ø´ØªØ±ÙŠÙ† Ø¢Ø®Ø±ÙŠÙ† ÙˆÙˆÙÙ‘Ø± Ø£ÙƒØ«Ø±", fulfulde:"Sooddu e yo'i, fayde kalan" },
  ...
  safetyText:      { en:"Always use Bambeh Escrow for payments. Meet in a safe, public place for pickup.", fr:"Utilisez toujours Bambeh Escrow pour les paiements. Rencontrez-vous dans un endroit sÃ»r et public.", pidgin:"Always use Bambeh Escrow for money. Meet for safe place wey people dey.", ar:"Ø§Ø³ØªØ®Ø¯Ù… Ø¯Ø§Ø¦Ù…Ù‹Ø§ Bambeh Escrow Ù„Ù„Ù…Ø¯ÙÙˆØ¹Ø§Øª. Ø§Ù„ØªÙ‚Ù ÙÙŠ Ù…ÙƒØ§Ù† Ø¢Ù…Ù† ÙˆØ¹Ø§Ù….", fulfulde:"Jom Bambeh Escrow ngam ceede fof. Yetto e yimÉ“e e toon laawol." },
  ...
  addToCartBtn:    { en:"Add to Cart", fr:"Ajouter au panier", pidgin:"Put for Cart", ar:"Ø£Ø¶Ù Ø¥Ù„Ù‰ Ø§Ù„Ø³Ù„Ø©", fulfulde:"RoÅ‹ku e Kartel" },
  addedBtn:        { en:"Added!", fr:"AjoutÃ© !", pidgin:"E don enter!", ar:"ØªÙ…Øª Ø§Ù„Ø¥Ø¶Ø§ÙØ©!", fulfulde:"RoÅ‹kaa!" },
  payNow:          { en:"Pay Now", fr:"Payer maintenant", pidgin:"Pay Now", ar:"Ø§Ø¯ÙØ¹ Ø§Ù„Ø¢Ù†", fulfulde:"Hol Hannde" },
  linkCopied:      { en:"Link copied!", fr:"Lien copiÃ© !", pidgin:"Link don copy!", ar:"ØªÙ… Ù†Ø³Ø® Ø§Ù„Ø±Ø§Ø¨Ø·!", fulfulde:"ToÉ“re nawnaa!" },
  addedToCart:     { en:"Added to cart", fr:"AjoutÃ© au panier", pidgin:"E don enter cart", ar:"ØªÙ…Øª Ø§Ù„Ø¥Ø¶Ø§ÙØ© Ø¥Ù„Ù‰ Ø§Ù„Ø³Ù„Ø©", fulfulde:"RoÅ‹kaa e Kartel" },
  ...
  browseFF:        { en:"Browse Farm Fresh", fr:"Parcourir Ferme FraÃ®che", pidgin:"Check Farm Fresh", ar:"ØªØµÙØ­ Ù…Ù†ØªØ¬Ø§Øª Ø§Ù„Ø²Ø±Ø§Ø¹Ø©", fulfulde:"Yiy Ley Ladde" },
  ...
  payConfirmed:    { en:"Payment confirmed. Your order is being processed.", fr:"Paiement confirmÃ©. Votre commande est en cours de traitement.", pidgin:"Payment don confirm. Dem dey process your order.", ar:"ØªÙ… ØªØ£ÙƒÙŠØ¯ Ø§Ù„Ø¯ÙØ¹. Ø¬Ø§Ø±Ù Ù…Ø¹Ø§Ù„Ø¬Ø© Ø·Ù„Ø¨Ùƒ.", fulfulde:"Ceede hoolnii. Sariyagol am jokki." },
  ...
  deliveryDetails:   { en:"Delivery Details", fr:"DÃ©tails de livraison", pidgin:"Delivery Info", ar:"ØªÙØ§ØµÙŠÙ„ Ø§Ù„ØªÙˆØµÙŠÙ„", fulfulde:"ToÉ“É“e Addirde" },
  ...
  addressPlaceholder:{ en:"e.g. Carrefour Elig-Essono, Quartier Omnisport, YaoundÃ©", fr:"ex. Carrefour Elig-Essono, Quartier Omnisport, YaoundÃ©", pidgin:"e.g. Carrefour Elig-Essono, YaoundÃ©", ar:"Ù…Ø«Ø§Ù„: ÙƒØ§Ø±ÙÙˆØ± Ø¥ÙŠÙ„ÙŠØº-Ø¥ÙŠØ³ÙˆÙ†ÙˆØŒ ÙŠØ§ÙˆÙ†Ø¯ÙŠ", fulfulde:"misaali: Carrefour Elig-Essono, YaoundÃ©" },
  phoneNumber:       { en:"Phone Number", fr:"NumÃ©ro de tÃ©lÃ©phone", pidgin:"Phone Number", ar:"Ø±Ù‚Ù… Ø§Ù„Ù‡Ø§ØªÙ", fulfulde:"Nomboro Telefon" },
  ...
  enterPhone:        { en:"Please enter a valid phone number.", fr:"Veuillez saisir un numÃ©ro de tÃ©lÃ©phone valide.", pidgin:"Put correct phone number abeg.", ar:"ÙŠØ±Ø¬Ù‰ Ø¥Ø¯Ø®Ø§Ù„ Ø±Ù‚Ù… Ù‡Ø§ØªÙ ØµØ­ÙŠØ­.", fulfulde:"Hollir nomboro telefon moÆ´Æ´o." },
  ...
  listYourProducePage: { en:"ðŸŒ¿ List Your Produce", fr:"ðŸŒ¿ Lister votre produit", pidgin:"ðŸŒ¿ Put Your Farm Thing", ar:"ðŸŒ¿ Ø£Ø¶Ù Ù…Ù†ØªØ¬Ùƒ Ø§Ù„Ø²Ø±Ø§Ø¹ÙŠ", fulfulde:"ðŸŒ¿ Hollir Ko'am ma" },
  step1Label:  { en:"Produce Details",             fr:"DÃ©tails du produit",          pidgin:"Wetin You Dey Sell",       ar:"ØªÙØ§ØµÙŠÙ„ Ø§Ù„Ù…Ù†ØªØ¬",          fulfulde:"ToÉ“É“e Ko'o" },
  step2Label:  { en:"Location & Description",      fr:"Lieu & Description",           pidgin:"Wapi e Wetin E Be",        ar:"Ø§Ù„Ù…ÙˆÙ‚Ø¹ ÙˆØ§Ù„ÙˆØµÙ",          fulfulde:"Toon e Haala" },
  ...
  category:    { en:"Category",                    fr:"CatÃ©gorie",                    pidgin:"Wetin Kind",               ar:"Ø§Ù„ÙØ¦Ø©",                  fulfulde:"GonÉ—inde" },
  unit:        { en:"Unit",                        fr:"UnitÃ©",                        pidgin:"How You Measure Am",       ar:"Ø§Ù„ÙˆØ­Ø¯Ø©",                 fulfulde:"Æ³eewnude" },
  priceLabel:  { en:"Price (FCFA)",                fr:"Prix (FCFA)",                  pidgin:"Price (FCFA)",             ar:"Ø§Ù„Ø³Ø¹Ø± (ÙØ±Ù†Ùƒ)",           fulfulde:"Njamndi (FCFA)" },
  ...
  locationPlaceholder: { en:"e.g. Bafoussam â€” MarchÃ© A, or NgaoundÃ©rÃ© â€” Centre-ville", fr:"ex. Bafoussam â€” MarchÃ© A, NgaoundÃ©rÃ© â€” Centre-ville", pidgin:"e.g. Bafoussam Market, NgaoundÃ©rÃ© Town", ar:"Ù…Ø«Ø§Ù„: Ø¨Ø§ÙÙˆØ³Ø§Ù… â€” Ø§Ù„Ø³ÙˆÙ‚ Ø£", fulfulde:"misaali: Bafoussam â€” Luumo A" },
  ...
  deliveryToggleDesc:  { en:"You can deliver to buyers in your area", fr:"Vous pouvez livrer aux acheteurs de votre zone", pidgin:"You fit carry am go buyer house", ar:"ÙŠÙ…ÙƒÙ†Ùƒ Ø§Ù„ØªÙˆØµÙŠÙ„ Ù„Ù„Ù…Ø´ØªØ±ÙŠÙ† ÙÙŠ Ù…Ù†Ø·Ù‚ØªÙƒ", fulfulde:"A waawi addude e soodinooÉ“e e ley maa" },
  description: { en:"Description",                fr:"Description",                  pidgin:"Explain Wetin E Be",       ar:"Ø§Ù„ÙˆØµÙ",                  fulfulde:"Haala Ko'o" },
  descPlaceholder: { en:"Describe your produce: freshness, harvest date, how it was grown, how to use it, delivery detailsâ€¦", fr:"DÃ©crivez votre produit : fraÃ®cheur, date de rÃ©colte, mode de culture, utilisation, dÃ©tails de livraisonâ€¦", pidgin:"Explain your thing: fresh or not, when dem pick am, how to use am, delivery infoâ€¦", ar:"ØµÙ Ù…Ù†ØªØ¬Ùƒ: Ø§Ù„Ø·Ø§Ø²Ø¬ÙŠØ©ØŒ ØªØ§Ø±ÙŠØ® Ø§Ù„Ø­ØµØ§Ø¯ØŒ Ø·Ø±ÙŠÙ‚Ø© Ø§Ù„Ø²Ø±Ø§Ø¹Ø©ØŒ ÙƒÙŠÙÙŠØ© Ø§Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù…ØŒ ØªÙØ§ØµÙŠÙ„ Ø§Ù„ØªÙˆØµÙŠÙ„â€¦", fulfulde:"Haal ko'am maa: keso wala É“uri, bimol nduri am, no addirdeâ€¦" },
  saveDraft:   { en:"ðŸ’¾ Save Draft",               fr:"ðŸ’¾ Enregistrer le brouillon",  pidgin:"ðŸ’¾ Save Am",               ar:"ðŸ’¾ Ø­ÙØ¸ Ø§Ù„Ù…Ø³ÙˆØ¯Ø©",         fulfulde:"ðŸ’¾ Dooro Kuwtorka" },
  nextStep:    { en:"Next Step â†’",                 fr:"Ã‰tape suivante â†’",             pidgin:"Next Step â†’",              ar:"Ø§Ù„Ø®Ø·ÙˆØ© Ø§Ù„ØªØ§Ù„ÙŠØ© â†’",       fulfulde:"ToÉ“É“e Nde â†’" },
  addPhotos:   { en:"Add Photos â†’",                fr:"Ajouter des photos â†’",         pidgin:"Add Photos â†’",             ar:"Ø£Ø¶Ù Ø§Ù„ØµÙˆØ± â†’",            fulfulde:"RoÅ‹ku Natal â†’" },
  photoHeader: { en:"Add Photos",                  fr:"Ajouter des photos",           pidgin:"Add Photos",               ar:"Ø£Ø¶Ù Ø§Ù„ØµÙˆØ±",              fulfulde:"RoÅ‹ku Natal" },
  ...
  photoSecure: { en:"ðŸ“¸ Photos are uploaded securely to Bambeh servers â€” not stored on your phone.", fr:"ðŸ“¸ Les photos sont tÃ©lÃ©chargÃ©es en toute sÃ©curitÃ© sur les serveurs Bambeh â€” non stockÃ©es sur votre tÃ©lÃ©phone.", pidgin:"ðŸ“¸ Photos dey upload secure for Bambeh server â€” no dey save for your phone.", ar:"ðŸ“¸ ÙŠØªÙ… Ø±ÙØ¹ Ø§Ù„ØµÙˆØ± Ø¨Ø£Ù…Ø§Ù† Ø¥Ù„Ù‰ Ø®ÙˆØ§Ø¯Ù… Bambeh â€” ÙˆÙ„Ø§ ØªÙØ®Ø²ÙŽÙ‘Ù† Ø¹Ù„Ù‰ Ù‡Ø§ØªÙÙƒ.", fulfulde:"ðŸ“¸ Natal callinaa hukkaande e Bambeh server â€” alaa e telefon maa." },
  tapUpload:   { en:"Tap to upload photos of your produce", fr:"Appuyez pour tÃ©lÃ©charger des photos de votre produit", pidgin:"Tap here to upload photos of your thing", ar:"Ø§Ù†Ù‚Ø± Ù„Ø±ÙØ¹ ØµÙˆØ± Ù…Ù†ØªØ¬Ùƒ", fulfulde:"Tap hanga callude natal ko'am maa" },
  ...
  pickupOnly:  { en:"Pickup only", fr:"Retrait uniquement", pidgin:"You go come pick am", ar:"Ø§Ø³ØªÙ„Ø§Ù… ÙÙ‚Ø·", fulfulde:"Ko Neldi Tan" },
  ...
  descPreview: { en:"Description preview", fr:"AperÃ§u de la description", pidgin:"See wetin you write", ar:"Ù…Ø¹Ø§ÙŠÙ†Ø© Ø§Ù„ÙˆØµÙ", fulfulde:"Yiy Haala" },
  minChars:    { en:"Min 20 characters", fr:"Min 20 caractÃ¨res", pidgin:"Min 20 letters", ar:"20 Ø­Ø±ÙÙ‹Ø§ ÙƒØ­Ø¯ Ø£Ø¯Ù†Ù‰", fulfulde:"AranÉ—e 20 ko É“uri" },
  charCount:   { en:(n:number)=>`${n} chars`, fr:(n:number)=>`${n} car.`, pidgin:(n:number)=>`${n} letters`, ar:(n:number)=>`${n} Ø­Ø±Ù`, fulfulde:(n:number)=>`${n} aranÉ—e` },
  ...
  posting:     { en:"Postingâ€¦", fr:"Publicationâ€¦", pidgin:"E dey postâ€¦", ar:"Ø¬Ø§Ø±Ù Ø§Ù„Ù†Ø´Ø±â€¦", fulfulde:"E nani holludeâ€¦" },
  ...
  listAnother: { en:"List Another Produce", fr:"Lister un autre produit", pidgin:"Put Another Thing", ar:"Ø£Ø¶Ù Ù…Ù†ØªØ¬Ù‹Ø§ Ø¢Ø®Ø±", fulfulde:"Hollir Koo Saka" },
  ...
  loginRequiredSub:{ en:"To post a listing that is visible to buyers worldwide, you need to be logged in.", fr:"Pour publier une annonce visible dans le monde entier, vous devez Ãªtre connectÃ©.", pidgin:"To post wetin people worldwide go see, you must login.", ar:"Ù„Ù†Ø´Ø± Ø¥Ø¹Ù„Ø§Ù† Ù…Ø±Ø¦ÙŠ Ù„Ù„Ù…Ø´ØªØ±ÙŠÙ† ÙÙŠ Ø¬Ù…ÙŠØ¹ Ø£Ù†Ø­Ø§Ø¡ Ø§Ù„Ø¹Ø§Ù„Ù…ØŒ ØªØ­ØªØ§Ø¬ Ø¥Ù„Ù‰ ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„.", fulfulde:"Hange hollirgol yii'ataa e aduna, a waÉ—ii Log In." },
  loginRequiredSub2:{ en:"Guest posts only save on your phone and no one else can see them.", fr:"Les publications en tant qu'invitÃ© ne sont enregistrÃ©es que sur votre tÃ©lÃ©phone.", pidgin:"Guest post na only your phone go save am, nobody else fit see.", ar:"Ø§Ù„Ù…Ù†Ø´ÙˆØ±Ø§Øª ÙƒØ¶ÙŠÙ ØªÙØ­ÙØ¸ Ø¹Ù„Ù‰ Ù‡Ø§ØªÙÙƒ ÙÙ‚Ø· ÙˆÙ„Ø§ ÙŠØ³ØªØ·ÙŠØ¹ Ø£Ø­Ø¯ Ø±Ø¤ÙŠØªÙ‡Ø§.", fulfulde:"Hollirgol bÃ©li Log In sinndidaa e telefon maa tan." },
  ...
  draftSaved:  { en:"Draft saved to your device âœ…", fr:"Brouillon enregistrÃ© sur votre appareil âœ…", pidgin:"Draft don save for your phone âœ…", ar:"ØªÙ… Ø­ÙØ¸ Ø§Ù„Ù…Ø³ÙˆØ¯Ø© Ø¹Ù„Ù‰ Ø¬Ù‡Ø§Ø²Ùƒ âœ…", fulfulde:"Kuwtorka doornaa e binndi maa âœ…" },
  ...
  payWithMoMo:   { en:"Pay with Mobile Money", fr:"Payer par Mobile Money", pidgin:"Pay with MoMo", ar:"Ø§Ø¯ÙØ¹ Ø¨Ø§Ù„Ù†Ù‚ÙˆØ¯ Ø§Ù„Ù…ØªÙ†Ù‚Ù„Ø©", fulfulde:"Hol e Ceede Telefon" },
  ...
  ussdPrompt:    { en:"A USSD prompt will appear on your phone. Enter your PIN to pay.", fr:"Une invite USSD apparaÃ®tra sur votre tÃ©lÃ©phone. Entrez votre PIN pour payer.", pidgin:"USSD go show for your phone. Put your PIN to pay.", ar:"Ø³ØªØ¸Ù‡Ø± Ø±Ø³Ø§Ù„Ø© USSD Ø¹Ù„Ù‰ Ù‡Ø§ØªÙÙƒ. Ø£Ø¯Ø®Ù„ Ø±Ù…Ø² PIN Ù„Ù„Ø¯ÙØ¹.", fulfulde:"USSD yii'ataa e telefon maa. RoÅ‹ku PIN maa hanga holirde." },
  confirmPay:    { en:(n:number)=>`Confirm & Pay ${n.toLocaleString("fr-CM")} XAF`, fr:(n:number)=>`Confirmer & Payer ${n.toLocaleString("fr-CM")} XAF`, pidgin:(n:number)=>`Confirm & Pay ${n.toLocaleString("fr-CM")} XAF`, ar:(n:number)=>`ØªØ£ÙƒÙŠØ¯ ÙˆØ¯ÙØ¹ ${n.toLocaleString("fr-CM")} XAF`, fulfulde:(n:number)=>`Hollu & Hol ${n.toLocaleString("fr-CM")} XAF` },
  checkPhone:    { en:"Check your phone!", fr:"VÃ©rifiez votre tÃ©lÃ©phone !", pidgin:"Check your phone!", ar:"ØªØ­Ù‚Ù‚ Ù…Ù† Ù‡Ø§ØªÙÙƒ!", fulfulde:"Yiy telefon maa!" },
  enterPin:      { en:"A payment request was sent to your number. Enter your PIN to approve.", fr:"Une demande de paiement a Ã©tÃ© envoyÃ©e Ã  votre numÃ©ro. Entrez votre PIN pour approuver.", pidgin:"Payment request don go your number. Put your PIN to approve.", ar:"ØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø¯ÙØ¹ Ø¥Ù„Ù‰ Ø±Ù‚Ù…Ùƒ. Ø£Ø¯Ø®Ù„ Ø±Ù…Ø² PIN Ù„Ù„Ù…ÙˆØ§ÙÙ‚Ø©.", fulfulde:"Sariya ceede nawnaa e nomboro maa. RoÅ‹ku PIN maa hanga wallitde." },
  sendingRequest:{ en:"Sending payment requestâ€¦", fr:"Envoi de la demande de paiementâ€¦", pidgin:"E dey send payment requestâ€¦", ar:"Ø¬Ø§Ø±Ù Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø§Ù„Ø¯ÙØ¹â€¦", fulfulde:"E nawna sariya ceedeâ€¦" },
  payFailed:     { en:"Payment Failed", fr:"Paiement Ã©chouÃ©", pidgin:"Payment No Work", ar:"ÙØ´Ù„ Ø§Ù„Ø¯ÙØ¹", fulfulde:"Hol Yawtaay" },
  questions:     { en:"Questions?", fr:"Questions ?", pidgin:"You get question?", ar:"Ø£Ø³Ø¦Ù„Ø©ØŸ", fulfulde:"Humpitaari?" },
  securedEncrypted: { en:"Secured & encrypted via CamPay", fr:"SÃ©curisÃ© & chiffrÃ© via CamPay", pidgin:"CamPay dey protect am well", ar:"Ø¢Ù…Ù† ÙˆÙ…Ø´ÙÙ‘Ø± Ø¹Ø¨Ø± CamPay", fulfulde:"CamPay holloo am" },
  cancel:        { en:"Cancel", fr:"Annuler", pidgin:"Cancel Am", ar:"Ø¥Ù„ØºØ§Ø¡", fulfulde:"Faggu" },
  paymentConfirmed: { en:"Payment Confirmed! ðŸŽ‰", fr:"Paiement confirmÃ© ! ðŸŽ‰", pidgin:"Payment Don Confirm! ðŸŽ‰", ar:"ØªÙ… ØªØ£ÙƒÙŠØ¯ Ø§Ù„Ø¯ÙØ¹! ðŸŽ‰", fulfulde:"Ceede Hoolnii! ðŸŽ‰" },
  orderProcessed:   { en:"Your order is being processed.", fr:"Votre commande est en cours de traitement.", pidgin:"Dem dey process your order.", ar:"Ø¬Ø§Ø±Ù Ù…Ø¹Ø§Ù„Ø¬Ø© Ø·Ù„Ø¨Ùƒ.", fulfulde:"Sariya am jokki." },
  waiting:          { en:(m:number,s:number)=>`Waitingâ€¦ ${m}:${String(s).padStart(2,"0")}`, fr:(m:number,s:number)=>`Attenteâ€¦ ${m}:${String(s).padStart(2,"0")}`, pidgin:(m:number,s:number)=>`E dey waitâ€¦ ${m}:${String(s).padStart(2,"0")}`, ar:(m:number,s:number)=>`Ø¬Ø§Ø±Ù Ø§Ù„Ø§Ù†ØªØ¸Ø§Ø±â€¦ ${m}:${String(s).padStart(2,"0")}`, fulfulde:(m:number,s:number)=>`E É—aÉ“É“iâ€¦ ${m}:${String(s).padStart(2,"0")}` },
