      ...
      <div className={`flex-1 flex flex-col ${showChat ? "flex" : "hidden md:flex"}`}>
        {selectedConvId && selectedParticipantId ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
            ...
            <p className="text-base font-medium text-gray-400">S�lectionnez une conversation</p>
            <p className="text-sm text-gray-300 mt-1">Choisissez � gauche pour commencer</p>
          </div>
        )}
      </div>
    </div>
