 ...
 * Bambeh Marketplace â€” Main App Header
                ...
                {menuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-1 w-48 bg-white rounded-xl shadow-lg border border-gray-200 z-20 py-1">
                      ...
                      <button onClick={async () => { await logout(); setMenuOpen(false); navigate("/"); }} className="w-full px-4 py-2 text-left text-sm text-red-600 hover:bg-red-50">DÃ©connexion</button>
                    </div>
                  </>
                )}
              </div>
