        ...
        <div className="p-5">
          {submitted ? (
            <div className="text-center py-6">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Signalement envoy?</h3>
              <p className="text-sm text-gray-500 mb-6">Merci. Notre ?quipe examinera votre signalement dans les plus brefs d?lais.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {itemDetails?.itemTitle && (
                <div className="bg-gray-50 rounded-xl px-3 py-2">
                  <p className="text-xs text-gray-500">Article signal?</p>
