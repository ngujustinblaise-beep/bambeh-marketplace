...
const CATEGORIES = ["?lectronique","V?tements & Mode","Maison & Jardin","Sport & Loisirs","V?hicules","Immobilier","Livres & ?ducation","Sant? & Beaut?","Alimentation","Autres"] as const;
const CONDITIONS = ["Neuf","Comme neuf","Bon ?tat","?tat correct","Pour pi?ces"] as const;
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">?tat <span className="text-red-500">*</span></label>
        ...
        <div>
          ...
          <textarea value={form.description} onChange={e=>set("description",e.target.value)} rows={4} placeholder="D?crivez votre article..." className="w-full border border-gray-300 rounded-xl px-3 py-2.5 text-sm outline-none resize-none" />
        </div>
