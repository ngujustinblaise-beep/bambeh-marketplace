...
const strings = {
  en: {
    ...
    noEscrowBody: 'This order was not placed under escrow, so there is nothing to hold or release.',
    ...
    loadErr: 'Could not load the escrow details.',
    notFound: 'Order not found, or it belongs to another account.',
    retry: 'Retry',
  },
  fr: {
    panelTitle: 'Protection s\u00e9questre',
    ...
    noEscrowBody: 'Cette commande n\u2019est pas sous s\u00e9questre, il n\u2019y a donc rien \u00e0 lib\u00e9rer.',
    ...
    loadErr: 'Impossible de charger les d\u00e9tails du s\u00e9questre.',
  ...
  pidgin: {
    ...
    noEscrowTitle: 'Direct payment',
    noEscrowBody: 'This order no pass through escrow, so nothing dey for hold or release.',
    ...
    loadErr: 'Escrow details no gree load.',
