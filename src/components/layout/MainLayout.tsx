 ...
 * - Bell icon in mobile bottom nav now uses useNotifications() directly
 *   so unread count reflects real Supabase data (not NotificationContext)
 * - Clicking the bell on mobile navigates to /notifications
 * - All other original behaviour preserved unchanged
 *
...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  // useNotifications fetches from Supabase and listens via Realtime.
  // Only runs when user is logged in (hook guards internally).
            ...
            >
              <div className="relative">
                ...
                {/* ── Notification badge on bell icon ──────────────────
                    Uses real unreadCount from useNotifications hook.
                    Shows green badge matching Bambeh brand colour.
                ─────────────────────────────────────────────────── */}
