...
// Brand icons are NOT exported by lucide-react. Inline SVG (real icons, no emoji).
const Facebook = ({ className = "", ...rest }: { className?: string; [key: string]: any }) => (
...
const Twitter = ({ className = "", ...rest }: { className?: string; [key: string]: any }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} {...rest}>
