...
const PostRentalProperty: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({ title: 'Property posted successfully!', description: 'Your rental property is now listed on Bambé' });
            navigate('/rentals');
        } catch (error) {
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <Input id="city" name="city" placeholder="e.g., Yaoundé" value={formData.city} onChange={handleInputChange} />
                                </div>
                                <div>
