 ...
 * Bambeh Marketplace â€” Vendor Dashboard Widget
...
// â”€â”€â”€ Order Status Badge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const ORDER_STATUS_CONFIG: Record<
  VendorOrder["status"],
  { label: string; color: string; icon: React.ElementType }
> = {
  pending: { label: "En attente", color: "text-yellow-600 bg-yellow-50", icon: Clock },
  confirmed: { label: "ConfirmÃ©", color: "text-blue-600 bg-blue-50", icon: CheckCircle },
  processing: { label: "En traitement", color: "text-purple-600 bg-purple-50", icon: Clock },
  shipped: { label: "ExpÃ©diÃ©", color: "text-teal-600 bg-teal-50", icon: Package },
  delivered: { label: "LivrÃ©", color: "text-green-600 bg-green-50", icon: CheckCircle },
  canceled: { label: "AnnulÃ©", color: "text-red-500 bg-red-50", icon: XCircle },
  refunded: { label: "RemboursÃ©", color: "text-gray-500 bg-gray-100", icon: AlertCircle },
};
...
// â”€â”€â”€ VendorDashboard â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-teal-50 border border-teal-100 rounded-xl p-4">
          ...
          <p className="text-lg font-bold text-teal-800">
            {earnings ? formatXAF(earnings.netEarningsXAF) : "â€”"}
          </p>
        </div>
        ...
        <div className="bg-green-50 border border-green-100 rounded-xl p-4">
          ...
          <p className="text-lg font-bold text-green-800">
            {earnings ? formatXAF(earnings.pendingWithdrawalXAF) : "â€”"}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
          <h3 className="text-sm font-semibold text-gray-900">Commandes rÃ©centes</h3>
          <button
            type="button"
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {formatXAF(order.totalXAF)} Â· {new Date(order.createdAt).toLocaleDateString("fr-CM")}
                  </p>
                </div>
