      ...
      {selectedProducts.size > 0 && (
        <div className="bulk-actions-bar">
          ...
          <div className="bulk-action-buttons">
            ...
            <button className="bulk-button delete" onClick={() => handleBulkAction('delete')}>ðŸ—‘Ã¯Â¸Â {t('vendor.delete')}</button>
          </div>
        </div>
      )}
                ...
                <tr key={product.id}>
                  ...
                  <td>
                    ...
                    >
                      ...
                      {product.stockQuantity <= product.lowStockThreshold && <span className="stock-warning">âš Ã¯Â¸Â</span>}
                    </div>
                  </td>
                  <td>
                  ...
                  <td>
                    <div className="action-buttons">
                      ...
                      <button className="action-btn delete" onClick={() => handleDeleteProduct(product.id)} title={t('vendor.delete')}>ðŸ—‘Ã¯Â¸Â</button>
                    </div>
                  </td>
                </tr>
              ))}
