...
export const CITIES_BY_REGION: Record<string, string[]> = {
  Centre:        ["Yaound�", "Obala", "Mbalmayo", "Bafia", "Nanga-Eboko", "Monat�l�", "Akonolinga", "Eseka"],
  Littoral:      ["Douala", "Nkongsamba", "Mbanga", "Ed�a", "Loum", "Manjo", "Ndoungu�"],
  West:          ["Bafoussam", "Dschang", "Foumban", "Mbouda", "Bafang", "Baham", "Bangangt�", "Foumbot"],
  ...
  Adamawa:       ["Ngaound�r�", "Meiganga", "Tibati", "Tign�re", "Banyo", "Vina"],
  South:         ["Ebolowa", "Kribi", "Sangm�lima", "Ambam", "Lolodorf", "Meyomessala"],
  East:          ["Bertoua", "Batouri", "Yokadouma", "Abong-Mbang", "Belabo", "Lomi�"],
  North:         ["Garoua", "Guider", "Pitoa", "Figuil", "Lagdo", "Rey-Bouba"],
  "Far North":   ["Maroua", "Kousseri", "Mora", "Yagoua", "Moulvoudaye", "Ka�l�", "Meri"],
};
...
export const QUARTIERS_BY_CITY: Record<string, string[]> = {
  ...
  // Ngaound�r�
  Ngaound�r�: ["Ngaoundal", "Dang", "Baladji", "Socaret", "Burkina", "Mbideng"],
  // Garoua
  Garoua: ["Lop�r�", "Bib�mi", "Ngong", "Roumd� Adjia", "Poumpoumr�"],
  // Maroua
  Maroua: ["Domayo", "Kakatar�", "Dougoi", "Hard�", "Founangu�"],
  // Ebolowa
  Ebolowa: ["Nkol-Etet", "Angal�", "Ntom", "Mbida-Mbi"],
  // Kribi
  Kribi: ["Centre", "Mbangue", "Afan Mabe", "Lolab�"],
  // Bertoua
