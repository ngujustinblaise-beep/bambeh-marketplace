// BAMBEH_DEPLOY_TOKEN__ADMINCOMMANDCENTER_FIX501_CLEAN
/**
...
type Section =
  ...
  | 'listings' | 'ads' | 'promos' | 'pharmacies' | 'utilities' | 'requests';
...
const NAV: Array<{
  ...
  { key: 'utilities', label: 'Water & Lights', icon: Droplet,
    badge: ['utility_live'] },
...
// BAMBEH_END_TOKEN__ADMINCOMMANDCENTER_FIX501__COMPLETE
