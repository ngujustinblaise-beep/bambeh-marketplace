...
export const T: TranslationMap = {
  ...
  retry:            { en: "Try again", fr: "Réessayer", pcm: "Try again", ar: "Ø­Ø§ÙˆÙ„ Ù…Ø¬Ø¯Ø¯Ù‹Ø§", ff: "Taftinoo" },
  ...
  noResults:        { en: "No results found", fr: "Aucun résultat trouvé", pcm: "Nothing dey here", ar: "Ù„Ø§ ØªÙˆØ¬Ø¯ Ù†ØªØ§Ø¦Ø¬", ff: "Walaa huunde e yiytaade" },
  seeAll:           { en: "See all", fr: "Voir tout", pcm: "See all", ar: "Ø¹Ø±Ø¶ Ø§Ù„ÙƒÙ„", ff: "Yiy fof" },
  viewDetails:      { en: "View details", fr: "Voir les détails", pcm: "See details", ar: "Ø¹Ø±Ø¶ Ø§Ù„ØªÙØ§ØµÙŠÙ„", ff: "Yiy kaaÉ—e" },
  ...
  linkCopied:       { en: "Link copied!", fr: "Lien copié!", pcm: "Link don copy!", ar: "ØªÙ… Ù†Ø³Ø® Ø§Ù„Ø±Ø§Ø¨Ø·!", ff: "Naawdi nawnaa!" },
  copied:           { en: "Copied!", fr: "Copié!", pcm: "E don copy!", ar: "ØªÙ… Ø§Ù„Ù†Ø³Ø®!", ff: "Nawnaa!" },
  ...
  comingSoon:       { en: "Coming soon", fr: "Bientôt disponible", pcm: "E go dey soon", ar: "Ù‚Ø±ÙŠØ¨Ù‹Ø§", ff: "Arta dey" },
  ...
  selectOne:        { en: "Select one", fr: "Sélectionner", pcm: "Pick one", ar: "Ø§Ø®ØªØ± ÙˆØ§Ø­Ø¯Ù‹Ø§", ff: "SuÉ“o gooto" },
  ...
  posted:           { en: "Posted", fr: "Publié", pcm: "E post", ar: "Ù†ÙØ´Ø±", ff: "Neldaa" },
  updated:          { en: "Updated", fr: "Mis à jour", pcm: "Updated", ar: "Ù…Ø­Ø¯ÙŽÙ‘Ø«", ff: "Fotnodaa" },
  views:            { en: "views", fr: "vues", pcm: "views", ar: "Ù…Ø´Ø§Ù‡Ø¯Ø§Øª", ff: "yiytaama" },
  active:           { en: "Active", fr: "Actif", pcm: "Active", ar: "Ù†Ø´Ø·", ff: "GollorÉ—o" },
  expired:          { en: "Expired", fr: "Expiré", pcm: "Expired", ar: "Ù…Ù†ØªÙ‡ÙŠ Ø§Ù„ØµÙ„Ø§Ø­ÙŠØ©", ff: "Tiimaa" },
  pending:          { en: "Pending", fr: "En attente", pcm: "Dey wait", ar: "Ù‚ÙŠØ¯ Ø§Ù„Ø§Ù†ØªØ¸Ø§Ø±", ff: "E yaaÉ—aa" },
  approved:         { en: "Approved", fr: "Approuvé", pcm: "Dem approve am", ar: "Ù…ÙˆØ§ÙÙ‚ Ø¹Ù„ÙŠÙ‡", ff: "JaÉ“aa" },
  rejected:         { en: "Rejected", fr: "Rejeté", pcm: "Dem reject am", ar: "Ù…Ø±ÙÙˆØ¶", ff: "HaÉ—aa" },
  ...
  goHome:           { en: "Go to Home", fr: "Retour à l'accueil", pcm: "Go home", ar: "Ø§Ù„Ø°Ù‡Ø§Ø¨ Ù„Ù„Ø±Ø¦ÙŠØ³ÙŠØ©", ff: "Yahoo galle" },
  ...
  settings:         { en: "Settings", fr: "Paramètres", pcm: "Settings", ar: "Ø§Ù„Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª", ff: "ToÉ“É“e" },
  logout:           { en: "Log out", fr: "Déconnexion", pcm: "Logout", ar: "ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø®Ø±ÙˆØ¬", ff: "Wurtude" },
  ...
  footerTagline:    { en: "Cameroon's trusted marketplace", fr: "La place de marché de confiance du Cameroun", pcm: "Cameroon trusted market", ar: "Ø§Ù„Ø³ÙˆÙ‚ Ø§Ù„Ù…ÙˆØ«ÙˆÙ‚ ÙÙŠ Ø§Ù„ÙƒØ§Ù…ÙŠØ±ÙˆÙ†", ff: "Suudu njiydi Kameruun" },
  ...
  footerTerms:      { en: "Terms & Conditions", fr: "Conditions Générales", pcm: "Terms & Conditions", ar: "Ø§Ù„Ø´Ø±ÙˆØ· ÙˆØ§Ù„Ø£Ø­ÙƒØ§Ù…", ff: "SarÉ—iiji" },
  footerPrivacy:    { en: "Privacy Policy", fr: "Politique de confidentialité", pcm: "Privacy Policy", ar: "Ø³ÙŠØ§Ø³Ø© Ø§Ù„Ø®ØµÙˆØµÙŠØ©", ff: "SarÉ—i Gaasooji" },
  ...
  footerSafety:     { en: "Safety & Security", fr: "Sécurité", pcm: "Safety & Security", ar: "Ø§Ù„Ø£Ù…Ø§Ù† ÙˆØ§Ù„Ø³Ù„Ø§Ù…Ø©", ff: "Kisinaare" },
  footerRights:     { en: "All rights reserved.", fr: "Tous droits réservés.", pcm: "All rights reserved.", ar: "Ø¬Ù…ÙŠØ¹ Ø§Ù„Ø­Ù‚ÙˆÙ‚ Ù…Ø­ÙÙˆØ¸Ø©.", ff: "Hakke fof kuuÉ—i." },
  footerDownload:   { en: "Download the app", fr: "Télécharger l'application", pcm: "Download the app", ar: "ØªØ­Ù…ÙŠÙ„ Ø§Ù„ØªØ·Ø¨ÙŠÙ‚", ff: "Wurno app É—oo" },
  ...
  footerCategory:   { en: "Categories", fr: "Catégories", pcm: "Categories", ar: "Ø§Ù„ÙØ¦Ø§Øª", ff: "Teelte" },
  ...
  categories:       { en: "Categories", fr: "Catégories", pcm: "Categories", ar: "Ø§Ù„ÙØ¦Ø§Øª", ff: "Teelte" },
  ...
  nearby:           { en: "Nearby", fr: "Ã€ proximité", pcm: "Near me", ar: "Ø¨Ø§Ù„Ù‚Ø±Ø¨ Ù…Ù†ÙŠ", ff: "Ko dow maa" },
  recentlyViewed:   { en: "Recently viewed", fr: "Récemment consultés", pcm: "You don see before", ar: "Ø´ÙˆÙ‡Ø¯ Ù…Ø¤Ø®Ø±Ù‹Ø§", ff: "Yiytaama jooni" },
  recommended:      { en: "Recommended for you", fr: "Recommandé pour vous", pcm: "We pick am for you", ar: "Ù…ÙˆØµÙ‰ Ø¨Ù‡ Ù„Ùƒ", ff: "Ko tiiÉ—naa maa" },
  ...
  category:         { en: "Category", fr: "Catégorie", pcm: "Category", ar: "Ø§Ù„ÙØ¦Ø©", ff: "Teele" },
  ...
  negotiable:       { en: "Price is negotiable", fr: "Prix négociable", pcm: "Price fit change", ar: "Ø§Ù„Ø³Ø¹Ø± Ù‚Ø§Ø¨Ù„ Ù„Ù„ØªÙØ§ÙˆØ¶", ff: "Njamndi hulÉ“inee" },
  ...
  jobsDesc:         { en: "Find your next opportunity", fr: "Trouvez votre prochaine opportunité", pcm: "Find work here", ar: "Ø§Ø¨Ø­Ø« Ø¹Ù† ÙØ±ØµØªÙƒ Ø§Ù„Ù‚Ø§Ø¯Ù…Ø©", ff: "Yiy golle maa" },
  ...
  remote:           { en: "Remote", fr: "Télétravail", pcm: "Remote", ar: "Ø¹Ù† Ø¨ÙØ¹Ø¯", ff: "E suudu" },
  ...
  experience:       { en: "Experience", fr: "Expérience", pcm: "Experience", ar: "Ø§Ù„Ø®Ø¨Ø±Ø©", ff: "Janngal" },
  ...
  jobsFound:        { en: (n: number) => `${n} job${n === 1 ? "" : "s"} found`, fr: (n: number) => `${n} offre${n === 1 ? "" : "s"} trouvée${n === 1 ? "" : "s"}`, pcm: (n: number) => `${n} job${n === 1 ? "" : "s"} dey`, ar: (n: number) => `ØªÙ… Ø¥ÙŠØ¬Ø§Ø¯ ${n} ÙˆØ¸ÙŠÙØ©`, ff: (n: number) => `${n} golle yiytaa` },
  ...
  servicesDesc:     { en: "Hire skilled professionals near you", fr: "Engagez des professionnels qualifiés près de vous", pcm: "Find skilled people near you", ar: "ÙˆØ¸Ù‘Ù Ù…Ø­ØªØ±ÙÙŠÙ† Ù…Ø§Ù‡Ø±ÙŠÙ† Ø¨Ø§Ù„Ù‚Ø±Ø¨ Ù…Ù†Ùƒ", ff: "Yiy tiiÉ—uÉ“e dow maa" },
  offerService:     { en: "Offer a service", fr: "Proposer un service", pcm: "Post your service", ar: "ØªÙ‚Ø¯ÙŠÙ… Ø®Ø¯Ù…Ø©", ff: "Fod tiiÉ—e maa" },
  bookNow:          { en: "Book now", fr: "Réserver maintenant", pcm: "Book am now", ar: "Ø§Ø­Ø¬Ø² Ø§Ù„Ø¢Ù†", ff: "Sooddo hannde" },
  serviceType:      { en: "Service type", fr: "Type de service", pcm: "Type of service", ar: "Ù†ÙˆØ¹ Ø§Ù„Ø®Ø¯Ù…Ø©", ff: "Mun'de tiiÉ—e" },
  availability:     { en: "Availability", fr: "Disponibilité", pcm: "When dem dey", ar: "Ø§Ù„ØªÙˆÙØ±", ff: "Himo waawi" },
  ...
  bookingRequest:   { en: "Booking request sent", fr: "Demande de réservation envoyée", pcm: "Booking request don go", ar: "ØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø·Ù„Ø¨ Ø§Ù„Ø­Ø¬Ø²", ff: "ÆŠaÉ“É“udi sooddi neldaa" },
  ...
  rentalsDesc:      { en: "Apartments, rooms & houses for rent", fr: "Appartements, chambres et maisons à louer", pcm: "Rent house, room or flat", ar: "Ø´Ù‚Ù‚ ÙˆØºØ±Ù ÙˆÙ…Ù†Ø§Ø²Ù„ Ù„Ù„Ø¥ÙŠØ¬Ø§Ø±", ff: "NjooÉ—am suudu e É—o woni" },
  ...
  furnished:        { en: "Furnished", fr: "Meublé", pcm: "Furnished", ar: "Ù…ÙØ±ÙˆØ´", ff: "KaaÉ—taa" },
  unfurnished:      { en: "Unfurnished", fr: "Non meublé", pcm: "Not furnished", ar: "ØºÙŠØ± Ù…ÙØ±ÙˆØ´", ff: "KaaÉ—taaka" },
  ...
  deposit:          { en: "Deposit", fr: "Dépôt de garantie", pcm: "Deposit", ar: "ÙˆØ¯ÙŠØ¹Ø©", ff: "Sooddi" },
  contactOwner:     { en: "Contact Owner", fr: "Contacter le propriétaire", pcm: "Talk to owner", ar: "Ø§Ù„ØªÙˆØ§ØµÙ„ Ù…Ø¹ Ø§Ù„Ù…Ø§Ù„Ùƒ", ff: "Æan boÉ—eejo" },
  ...
  subExpired:       { en: "Your subscription has expired", fr: "Votre abonnement a expiré", pcm: "Your subscription don expire", ar: "Ø§Ù†ØªÙ‡Øª ØµÙ„Ø§Ø­ÙŠØ© Ø§Ø´ØªØ±Ø§ÙƒÙƒ", ff: "Sooddi maa tiimii" },
  ...
  supportBambehDesc:{ en: "Help us grow and keep the platform free", fr: "Aidez-nous à grandir et garder la plateforme gratuite", pcm: "Help us grow and keep it free", ar: "Ø³Ø§Ø¹Ø¯Ù†Ø§ Ø¹Ù„Ù‰ Ø§Ù„Ù†Ù…Ùˆ ÙˆØ§Ù„Ø¥Ø¨Ù‚Ø§Ø¡ Ø¹Ù„Ù‰ Ø§Ù„Ù…Ù†ØµØ© Ù…Ø¬Ø§Ù†ÙŠØ©", ff: "Ballam, hukk Bambeh teri" },
  ...
  referralBonus:    { en: "Earn coins for each referral", fr: "Gagnez des pièces pour chaque parrainage", pcm: "Earn coins when you refer", ar: "Ø§ÙƒØ³Ø¨ Ø¹Ù…Ù„Ø§Øª Ù…Ù‚Ø§Ø¨Ù„ ÙƒÙ„ ØªØ±Ø´ÙŠØ­", ff: "Hoot ceede to É“ennugol" },
  ...
  foundedIn:        { en: "Founded in Cameroon", fr: "Fondé au Cameroun", pcm: "Founded for Cameroon", ar: "ØªØ£Ø³Ø³Øª ÙÙŠ Ø§Ù„ÙƒØ§Ù…ÙŠØ±ÙˆÙ†", ff: "FuÉ—daa e Kameruun" },
  ...
  registrationNo:   { en: "Registration no.", fr: "Numéro d'immatriculation", pcm: "Reg number", ar: "Ø±Ù‚Ù… Ø§Ù„ØªØ³Ø¬ÙŠÙ„", ff: "Nimero" },
  address:          { en: "Address", fr: "Adresse", pcm: "Address", ar: "Ø§Ù„Ø¹Ù†ÙˆØ§Ù†", ff: "ÆŠo Woni" },
  phone:            { en: "Phone", fr: "Téléphone", pcm: "Phone", ar: "Ø§Ù„Ù‡Ø§ØªÙ", ff: "Telefon" },
  ...
  established:      { en: "Established", fr: "Créé en", pcm: "Founded", ar: "ØªØ£Ø³Ø³Øª", ff: "FuÉ—daa" },
  industry:         { en: "Industry", fr: "Secteur", pcm: "Industry", ar: "Ø§Ù„Ù‚Ø·Ø§Ø¹", ff: "Golle" },
  employees:        { en: "Employees", fr: "Employés", pcm: "Workers", ar: "Ø§Ù„Ù…ÙˆØ¸ÙÙˆÙ†", ff: "Gollooji" },
  verified:         { en: "Verified company", fr: "Entreprise vérifiée", pcm: "Verified company", ar: "Ø´Ø±ÙƒØ© Ù…ÙˆØ«Ù‚Ø©", ff: "Sosirde jaÉ“É“aama" },
  ...
  helpCenterDesc:   { en: "Find answers to your questions", fr: "Trouvez des réponses à vos questions", pcm: "Find answers here", ar: "Ø§Ø¨Ø­Ø« Ø¹Ù† Ø¥Ø¬Ø§Ø¨Ø§Øª Ù„Ø£Ø³Ø¦Ù„ØªÙƒ", ff: "Yiy jaabaaji É—aÉ“É“aajamee" },
  faq:              { en: "Frequently asked questions", fr: "Questions fréquemment posées", pcm: "FAQ", ar: "Ø§Ù„Ø£Ø³Ø¦Ù„Ø© Ø§Ù„Ø´Ø§Ø¦Ø¹Ø©", ff: "ÆŠaÉ“É“aaje heewÉ—e" },
  gettingStarted:   { en: "Getting started", fr: "Démarrer", pcm: "How to start", ar: "Ø§Ù„Ø¨Ø¯Ø¡", ff: "FuÉ—É—ude" },
  ...
  safetyHelp:       { en: "Safety & Scams", fr: "Sécurité & Arnaques", pcm: "Safety and Scams", ar: "Ø§Ù„Ø£Ù…Ø§Ù† ÙˆØ§Ù„Ø§Ø­ØªÙŠØ§Ù„", ff: "Kisinaare e Fenaande" },
  technicalHelp:    { en: "Technical issues", fr: "Problèmes techniques", pcm: "Technical problems", ar: "Ø§Ù„Ù…Ø´ÙƒÙ„Ø§Øª Ø§Ù„ØªÙ‚Ù†ÙŠØ©", ff: "Tuma jiiÉ“i" },
  searchHelp:       { en: "Search help", fr: "Aide à la recherche", pcm: "Search help", ar: "مساعدة البحث", ff: "Ballal yiylaade" },
  wasHelpful:       { en: "Was this helpful?", fr: "Cela vous a-t-il aidé?", pcm: "E help you?", ar: "Ù‡Ù„ ÙƒØ§Ù† Ù‡Ø°Ø§ Ù…ÙÙŠØ¯Ù‹Ø§ØŸ", ff: "ÆŠon ballii?" },
  ...
  contactSupportDesc:{ en: "We're here to help â€” reach out anytime", fr: "Nous sommes là pour vous aider â€” contactez-nous à tout moment", pcm: "We dey here to help you anytime", ar: "Ù†Ø­Ù† Ù‡Ù†Ø§ Ù„Ù„Ù…Ø³Ø§Ø¹Ø¯Ø© â€” ØªÙˆØ§ØµÙ„ Ù…Ø¹Ù†Ø§ ÙÙŠ Ø£ÙŠ ÙˆÙ‚Øª", ff: "Min É—oo e ballugol â€” Æan saa'i fof" },
  ...
  messageSent:      { en: "Message sent! We'll reply within 24 hours.", fr: "Message envoyé! Nous répondrons dans 24 heures.", pcm: "Message don go! We go reply within 24 hours.", ar: "ØªÙ… Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„Ø±Ø³Ø§Ù„Ø©! Ø³Ù†Ø±Ø¯ Ø®Ù„Ø§Ù„ 24 Ø³Ø§Ø¹Ø©.", ff: "Haala neldiima! Min yettotoo e sahaa 24." },
  liveChat:         { en: "Live chat", fr: "Chat en direct", pcm: "Live chat", ar: "Ø§Ù„Ù…Ø­Ø§Ø¯Ø«Ø© Ø§Ù„Ù…Ø¨Ø§Ø´Ø±Ø©", ff: "Haala hannde" },
  responseTime:     { en: "Average response time: under 2 hours", fr: "Délai de réponse moyen: moins de 2 heures", pcm: "We usually reply in 2 hours", ar: "ÙˆÙ‚Øª Ø§Ù„Ø§Ø³ØªØ¬Ø§Ø¨Ø© Ø§Ù„Ù…ØªÙˆØ³Ø·: Ø£Ù‚Ù„ Ù…Ù† Ø³Ø§Ø¹ØªÙŠÙ†", ff: "Yettotoo ko É“uri 2 saate" },
  ...
  safetySecurity:   { en: "Safety & Security", fr: "Sécurité", pcm: "Safety & Security", ar: "Ø§Ù„Ø£Ù…Ø§Ù† ÙˆØ§Ù„Ø³Ù„Ø§Ù…Ø©", ff: "Kisinaare" },
  safetyDesc:       { en: "Your safety is our top priority", fr: "Votre sécurité est notre priorité absolue", pcm: "Your safety na our priority", ar: "Ø³Ù„Ø§Ù…ØªÙƒ Ù‡ÙŠ Ø£ÙˆÙ„ÙˆÙŠØªÙ†Ø§ Ø§Ù„Ù‚ØµÙˆÙ‰", ff: "Kisinaare maa ko waÉ—i fof" },
  avoidScams:       { en: "How to avoid scams", fr: "Comment éviter les arnaques", pcm: "How to no fall for scam", ar: "ÙƒÙŠÙÙŠØ© ØªØ¬Ù†Ø¨ Ø§Ù„Ø§Ø­ØªÙŠØ§Ù„", ff: "No haÉ—mi fenaande" },
  ...
  securePayments:   { en: "Secure payment tips", fr: "Conseils de paiement sécurisé", pcm: "How to pay safe", ar: "Ù†ØµØ§Ø¦Ø­ Ø§Ù„Ø¯ÙØ¹ Ø§Ù„Ø¢Ù…Ù†", ff: "YoÉ“de kisinaare" },
  ...
  twoFactor:        { en: "Two-factor authentication", fr: "Authentification à deux facteurs", pcm: "Two-factor authentication", ar: "Ø§Ù„Ù…ØµØ§Ø¯Ù‚Ø© Ø§Ù„Ø«Ù†Ø§Ø¦ÙŠØ©", ff: "Damal É—iÉ—i" },
  blockedUsers:     { en: "Blocked users", fr: "Utilisateurs bloqués", pcm: "Blocked users", ar: "Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙˆÙ† Ø§Ù„Ù…Ø­Ø¸ÙˆØ±ÙˆÙ†", ff: "Æe haÉ—taa" },
  safetyTip:        { en: "Safety tip:", fr: "Conseil de sécurité:", pcm: "Safety tip:", ar: ":Ù†ØµÙŠØ­Ø© Ø£Ù…Ø§Ù†", ff: "Miijo kisinaare:" },
  ...
  termsTitle:       { en: "Terms & Conditions", fr: "Conditions Générales d'Utilisation", pcm: "Terms and Conditions", ar: "Ø§Ù„Ø´Ø±ÙˆØ· ÙˆØ§Ù„Ø£Ø­ÙƒØ§Ù…", ff: "SarÉ—iiji e Golle" },
  ...
  lastUpdated:      { en: "Last updated", fr: "Dernière mise à jour", pcm: "Last updated", ar: "Ø¢Ø®Ø± ØªØ­Ø¯ÙŠØ«", ff: "Fotnodaa É“enndi" },
  ...
  tableOfContents:  { en: "Table of contents", fr: "Table des matières", pcm: "Table of contents", ar: "Ø¬Ø¯ÙˆÙ„ Ø§Ù„Ù…Ø­ØªÙˆÙŠØ§Øª", ff: "Listu kaaÉ—e" },
  ...
  privacyTitle:     { en: "Privacy Policy", fr: "Politique de confidentialité", pcm: "Privacy Policy", ar: "Ø³ÙŠØ§Ø³Ø© Ø§Ù„Ø®ØµÙˆØµÙŠØ©", ff: "SarÉ—i Gaasooji" },
  privacyDesc:      { en: "How BAMBEH SARL collects and uses your data", fr: "Comment BAMBEH SARL collecte et utilise vos données", pcm: "How Bambeh uses your data", ar: "ÙƒÙŠÙÙŠØ© Ø¬Ù…Ø¹ Ø¨Ø§Ù…Ø¨ÙŠÙ‡ Ù„Ø¨ÙŠØ§Ù†Ø§ØªÙƒ ÙˆØ§Ø³ØªØ®Ø¯Ø§Ù…Ù‡Ø§", fr2: "Comment BAMBEH SARL utilise vos données", ff: "No Bambeh waÉ—i É—atum maa" },
  dataCollected:    { en: "Data we collect", fr: "Données que nous collectons", pcm: "Data we dey collect", ar: "Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ØªÙŠ Ù†Ø¬Ù…Ø¹Ù‡Ø§", ff: "ÆŠatum min hoÉ—taa" },
  howWeUseData:     { en: "How we use your data", fr: "Comment nous utilisons vos données", pcm: "How we use your data", ar: "ÙƒÙŠÙÙŠØ© Ø§Ø³ØªØ®Ø¯Ø§Ù…Ù†Ø§ Ù„Ø¨ÙŠØ§Ù†Ø§ØªÙƒ", ff: "No waÉ—mi É—atum maa" },
  dataSharing:      { en: "Data sharing", fr: "Partage des données", pcm: "Data sharing", ar: "Ù…Ø´Ø§Ø±ÙƒØ© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª", ff: "Wadande É—atum" },
  ...
  dataDeletion:     { en: "Request data deletion", fr: "Demander la suppression des données", pcm: "Request data deletion", ar: "Ø·Ù„Ø¨ Ø­Ø°Ù Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª", ff: "ÆŠaÉ“É“o sooddi É—atum" },
  privacyContact:   { en: "Privacy questions? Email", fr: "Questions sur la confidentialité? Ã‰crivez à", pcm: "Privacy question? Email", ar: "Ø£Ø³Ø¦Ù„Ø© Ø¹Ù† Ø§Ù„Ø®ØµÙˆØµÙŠØ©ØŸ Ø£Ø±Ø³Ù„ Ø¨Ø±ÙŠØ¯Ù‹Ø§ Ø¥Ù„Ù‰", ff: "ÆŠaÉ“É“aaje gaasooji? Email" },
  ...
  poweredBy:        { en: "Powered by CamPay Â· MTN MoMo & Orange Money", fr: "Propulsé par CamPay Â· MTN MoMo & Orange Money", pcm: "Na CamPay power am Â· MTN MoMo & Orange Money", ar: "Ù…Ø¯Ø¹ÙˆÙ… Ø¨Ù€ CamPay Â· MTN MoMo Ùˆ Orange Money", ff: "CamPay saÉ—ii Â· MTN MoMo & Orange Money" },
  mtnOrOrange:      { en: "MTN or Orange phone number", fr: "Numéro MTN ou Orange", pcm: "MTN or Orange number", ar: "Ø±Ù‚Ù… MTN Ø£Ùˆ Orange", ff: "Nimero MTN walla Orange" },
  ...
  checkPhone:       { en: "Check your phone", fr: "Vérifiez votre téléphone", pcm: "Check your phone", ar: "ØªØ­Ù‚Ù‚ Ù…Ù† Ù‡Ø§ØªÙÙƒ", ff: "Yiy Telefon maa" },
  ...
  paymentConfirmed: { en: "Payment confirmed!", fr: "Paiement confirmé!", pcm: "Payment don confirm!", ar: "ØªÙ… ØªØ£ÙƒÙŠØ¯ Ø§Ù„Ø¯ÙØ¹!", ff: "YoÉ“de jaÉ“É“ii!" },
  orderProcessed:   { en: "Your order has been processed", fr: "Votre commande a été traitée", pcm: "Your order don process", ar: "ØªÙ…Øª Ù…Ø¹Ø§Ù„Ø¬Ø© Ø·Ù„Ø¨Ùƒ", ff: "ÆŠaÉ“É“aade maa waÉ—aa" },
  ...
  securedEncrypted: { en: "Secured & encrypted", fr: "Sécurisé & chiffré", pcm: "Secured and encrypted", ar: "Ù…Ø­Ù…ÙŠ ÙˆÙ…Ø´ÙØ±", ff: "Kisinaama e É“oggoodaama" },
  orderPlaced:      { en: "Order placed!", fr: "Commande passée!", pcm: "Order don place!", ar: "ØªÙ… ØªÙ‚Ø¯ÙŠÙ… Ø§Ù„Ø·Ù„Ø¨!", ff: "ÆŠaÉ“É“aade fuÉ—ii!" },
  payConfirmed:     { en: "Payment confirmed. Your order is on its way.", fr: "Paiement confirmé. Votre commande est en route.", pcm: "Payment confirmed. Your order dey come.", ar: "ØªÙ… ØªØ£ÙƒÙŠØ¯ Ø§Ù„Ø¯ÙØ¹. Ø·Ù„Ø¨Ùƒ ÙÙŠ Ø§Ù„Ø·Ø±ÙŠÙ‚.", ff: "YoÉ“de jaÉ“É“ii. ÆŠaÉ“É“aade maa arii." },
  ...
  addedBtn:         { en: "Added!", fr: "Ajouté!", pcm: "Added!", ar: "ØªÙ…Øª Ø§Ù„Ø¥Ø¶Ø§ÙØ©!", ff: "Fodaa!" },
  addedToCart:      { en: "Added to cart", fr: "Ajouté au panier", pcm: "Added to cart", ar: "ØªÙ…Øª Ø§Ù„Ø¥Ø¶Ø§ÙØ© Ø¥Ù„Ù‰ Ø§Ù„Ø³Ù„Ø©", ff: "Fodaa e paani" },
