...
export const T: TranslationMap = {
  ...
  retry:            { en: "Try again", fr: "R�essayer", pcm: "Try again", ar: "???? ??????", ff: "Taftinoo" },
  ...
  noResults:        { en: "No results found", fr: "Aucun r�sultat trouv�", pcm: "Nothing dey here", ar: "?? ???? ?????", ff: "Walaa huunde e yiytaade" },
  seeAll:           { en: "See all", fr: "Voir tout", pcm: "See all", ar: "??? ????", ff: "Yiy fof" },
  viewDetails:      { en: "View details", fr: "Voir les d�tails", pcm: "See details", ar: "??? ????????", ff: "Yiy kaa?e" },
  ...
  linkCopied:       { en: "Link copied!", fr: "Lien copi�!", pcm: "Link don copy!", ar: "?? ??? ??????!", ff: "Naawdi nawnaa!" },
  copied:           { en: "Copied!", fr: "Copi�!", pcm: "E don copy!", ar: "?? ?????!", ff: "Nawnaa!" },
  ...
  comingSoon:       { en: "Coming soon", fr: "Bient�t disponible", pcm: "E go dey soon", ar: "??????", ff: "Arta dey" },
  ...
  selectOne:        { en: "Select one", fr: "S�lectionner", pcm: "Pick one", ar: "???? ??????", ff: "Su?o gooto" },
  ...
  posted:           { en: "Posted", fr: "Publi�", pcm: "E post", ar: "????", ff: "Neldaa" },
  updated:          { en: "Updated", fr: "Mis � jour", pcm: "Updated", ar: "??????", ff: "Fotnodaa" },
  views:            { en: "views", fr: "vues", pcm: "views", ar: "???????", ff: "yiytaama" },
  active:           { en: "Active", fr: "Actif", pcm: "Active", ar: "???", ff: "Gollor?o" },
  expired:          { en: "Expired", fr: "Expir�", pcm: "Expired", ar: "????? ????????", ff: "Tiimaa" },
  pending:          { en: "Pending", fr: "En attente", pcm: "Dey wait", ar: "??? ????????", ff: "E yaa?aa" },
  approved:         { en: "Approved", fr: "Approuv�", pcm: "Dem approve am", ar: "????? ????", ff: "Ja?aa" },
  rejected:         { en: "Rejected", fr: "Rejet�", pcm: "Dem reject am", ar: "?????", ff: "Ha?aa" },
  ...
  goHome:           { en: "Go to Home", fr: "Retour � l'accueil", pcm: "Go home", ar: "?????? ????????", ff: "Yahoo galle" },
  ...
  settings:         { en: "Settings", fr: "Param�tres", pcm: "Settings", ar: "?????????", ff: "To??e" },
  logout:           { en: "Log out", fr: "D�connexion", pcm: "Logout", ar: "????? ??????", ff: "Wurtude" },
  ...
  // -- FOOTER -------------------------------------------------------------------
  footerTagline:    { en: "Cameroon's trusted marketplace", fr: "La place de march� de confiance du Cameroun", pcm: "Cameroon trusted market", ar: "????? ??????? ?? ?????????", ff: "Suudu njiydi Kameruun" },
  footerAbout:      { en: "About Bambeh", fr: "� propos de Bambeh", pcm: "About Bambeh", ar: "?? ??????", ff: "E dow Bambeh" },
  footerHelp:       { en: "Help Center", fr: "Centre d'aide", pcm: "Help Center", ar: "???? ????????", ff: "Laa?al Ballal" },
  footerTerms:      { en: "Terms & Conditions", fr: "Conditions G�n�rales", pcm: "Terms & Conditions", ar: "?????? ????????", ff: "Sar?iiji" },
  footerPrivacy:    { en: "Privacy Policy", fr: "Politique de confidentialit�", pcm: "Privacy Policy", ar: "????? ????????", ff: "Sar?i Gaasooji" },
  footerContact:    { en: "Contact Support", fr: "Contacter le support", pcm: "Contact Support", ar: "????? ?? ?????", ff: "?anndital Ballal" },
  footerSafety:     { en: "Safety & Security", fr: "S�curit�", pcm: "Safety & Security", ar: "?????? ????????", ff: "Kisinaare" },
  footerRights:     { en: "All rights reserved.", fr: "Tous droits r�serv�s.", pcm: "All rights reserved.", ar: "???? ?????? ??????.", ff: "Hakke fof kuu?i." },
  footerDownload:   { en: "Download the app", fr: "T�l�charger l'application", pcm: "Download the app", ar: "????? ???????", ff: "Wurno app ?oo" },
  ...
  footerCategory:   { en: "Categories", fr: "Cat�gories", pcm: "Categories", ar: "??????", ff: "Teelte" },

  // -- MAIN LAYOUT --------------------------------------------------------------
  explore:          { en: "Explore", fr: "Explorer", pcm: "Explore", ar: "???????", ff: "Gite" },
  categories:       { en: "Categories", fr: "Cat�gories", pcm: "Categories", ar: "??????", ff: "Teelte" },
  featured:         { en: "Featured", fr: "� la une", pcm: "Featured", ar: "????", ff: "Tii?ngal" },
  trending:         { en: "Trending", fr: "Tendances", pcm: "Trending", ar: "????", ff: "Reedu" },
  nearby:           { en: "Nearby", fr: "� proximit�", pcm: "Near me", ar: "?????? ???", ff: "Ko dow maa" },
  recentlyViewed:   { en: "Recently viewed", fr: "R�cemment consult�s", pcm: "You don see before", ar: "???? ??????", ff: "Yiytaama jooni" },
  recommended:      { en: "Recommended for you", fr: "Recommand� pour vous", pcm: "We pick am for you", ar: "???? ?? ??", ff: "Ko tii?naa maa" },
  ...
  condition:        { en: "Condition", fr: "�tat", pcm: "Condition", ar: "??????", ff: "Himo" },
  ...
  category:         { en: "Category", fr: "Cat�gorie", pcm: "Category", ar: "?????", ff: "Teele" },
  ...
  negotiable:       { en: "Price is negotiable", fr: "Prix n�gociable", pcm: "Price fit change", ar: "????? ???? ???????", ff: "Njamndi hul?inee" },
  ...
  jobsDesc:         { en: "Find your next opportunity", fr: "Trouvez votre prochaine opportunit�", pcm: "Find work here", ar: "???? ?? ????? ???????", ff: "Yiy golle maa" },
  ...
  remote:           { en: "Remote", fr: "T�l�travail", pcm: "Remote", ar: "?? ????", ff: "E suudu" },
  ...
  experience:       { en: "Experience", fr: "Exp�rience", pcm: "Experience", ar: "??????", ff: "Janngal" },
  ...
  jobsFound:        { en: (n: number) => `${n} job${n === 1 ? "" : "s"} found`, fr: (n: number) => `${n} offre${n === 1 ? "" : "s"} trouv�e${n === 1 ? "" : "s"}`, pcm: (n: number) => `${n} job${n === 1 ? "" : "s"} dey`, ar: (n: number) => `?? ????? ${n} ?????`, ff: (n: number) => `${n} golle yiytaa` },

  // -- SERVICES PAGE ------------------------------------------------------------
  services:         { en: "Services", fr: "Services", pcm: "Services", ar: "???????", ff: "Tii?e" },
  servicesDesc:     { en: "Hire skilled professionals near you", fr: "Engagez des professionnels qualifi�s pr�s de vous", pcm: "Find skilled people near you", ar: "???? ??????? ?????? ?????? ???", ff: "Yiy tii?u?e dow maa" },
  offerService:     { en: "Offer a service", fr: "Proposer un service", pcm: "Post your service", ar: "????? ????", ff: "Fod tii?e maa" },
  bookNow:          { en: "Book now", fr: "R�server maintenant", pcm: "Book am now", ar: "???? ????", ff: "Sooddo hannde" },
  serviceType:      { en: "Service type", fr: "Type de service", pcm: "Type of service", ar: "??? ??????", ff: "Mun'de tii?e" },
  availability:     { en: "Availability", fr: "Disponibilit�", pcm: "When dem dey", ar: "??????", ff: "Himo waawi" },
  rate:             { en: "Rate", fr: "Tarif", pcm: "Rate", ar: "?????", ff: "Njamndi" },
  perHour:          { en: "per hour", fr: "par heure", pcm: "per hour", ar: "?? ??????", ff: "to saate" },
  perDay:           { en: "per day", fr: "par jour", pcm: "per day", ar: "?? ?????", ff: "to �alorma" },
  perJob:           { en: "per job", fr: "par prestation", pcm: "per job", ar: "?????? ???????", ff: "to tii?e" },
  bookingRequest:   { en: "Booking request sent", fr: "Demande de r�servation envoy�e", pcm: "Booking request don go", ar: "?? ????? ??? ?????", ff: "?a??udi sooddi neldaa" },
  ...
  rentalsDesc:      { en: "Apartments, rooms & houses for rent", fr: "Appartements, chambres et maisons � louer", pcm: "Rent house, room or flat", ar: "??? ???? ?????? ???????", ff: "Njoo?am suudu e ?o woni" },
  ...
  furnished:        { en: "Furnished", fr: "Meubl�", pcm: "Furnished", ar: "?????", ff: "Kaa?taa" },
  unfurnished:      { en: "Unfurnished", fr: "Non meubl�", pcm: "Not furnished", ar: "??? ?????", ff: "Kaa?taaka" },
  ...
  deposit:          { en: "Deposit", fr: "D�p�t de garantie", pcm: "Deposit", ar: "?????", ff: "Sooddi" },
  contactOwner:     { en: "Contact Owner", fr: "Contacter le propri�taire", pcm: "Talk to owner", ar: "??????? ?? ??????", ff: "?an bo?eejo" },
  ...
  subExpired:       { en: "Your subscription has expired", fr: "Votre abonnement a expir�", pcm: "Your subscription don expire", ar: "????? ?????? ???????", ff: "Sooddi maa tiimii" },

  // -- SUPPORT BAMBEH PAGE ------------------------------------------------------
  supportBambeh:    { en: "Support Bambeh", fr: "Soutenir Bambeh", pcm: "Support Bambeh", ar: "??? ??????", ff: "Ballal Bambeh" },
  supportBambehDesc:{ en: "Help us grow and keep the platform free", fr: "Aidez-nous � grandir et garder la plateforme gratuite", pcm: "Help us grow and keep it free", ar: "?????? ??? ????? ???????? ??? ?????? ??????", ff: "Ballam, hukk Bambeh teri" },
  ...
  referralBonus:    { en: "Earn coins for each referral", fr: "Gagnez des pi�ces pour chaque parrainage", pcm: "Earn coins when you refer", ar: "???? ????? ????? ?? ?????", ff: "Hoot ceede to ?ennugol" },

  // -- ABOUT US PAGE ------------------------------------------------------------
  about:            { en: "About Us", fr: "� propos", pcm: "About Us", ar: "??????? ???", ff: "E dow min" },
  ...
  ourTeam:          { en: "Our Team", fr: "Notre �quipe", pcm: "Our Team", ar: "??????", ff: "Koodi memen" },
  ourStory:         { en: "Our Story", fr: "Notre Histoire", pcm: "Our Story", ar: "?????", ff: "Haala memen" },
  foundedIn:        { en: "Founded in Cameroon", fr: "Fond� au Cameroun", pcm: "Founded for Cameroon", ar: "????? ?? ?????????", ff: "Fu?daa e Kameruun" },
  ...
  registrationNo:   { en: "Registration no.", fr: "Num�ro d'immatriculation", pcm: "Reg number", ar: "??? ???????", ff: "Nimero" },
  address:          { en: "Address", fr: "Adresse", pcm: "Address", ar: "???????", ff: "?o Woni" },
  phone:            { en: "Phone", fr: "T�l�phone", pcm: "Phone", ar: "??????", ff: "Telefon" },
  email:            { en: "Email", fr: "E-mail", pcm: "Email", ar: "?????? ??????????", ff: "Email" },
  website:          { en: "Website", fr: "Site web", pcm: "Website", ar: "?????? ??????????", ff: "Laa?al" },
  established:      { en: "Established", fr: "Cr�� en", pcm: "Founded", ar: "?????", ff: "Fu?daa" },
  industry:         { en: "Industry", fr: "Secteur", pcm: "Industry", ar: "??????", ff: "Golle" },
  employees:        { en: "Employees", fr: "Employ�s", pcm: "Workers", ar: "????????", ff: "Gollooji" },
  verified:         { en: "Verified company", fr: "Entreprise v�rifi�e", pcm: "Verified company", ar: "???? ?????", ff: "Sosirde ja??aama" },

  // -- HELP CENTER PAGE ---------------------------------------------------------
  helpCenter:       { en: "Help Center", fr: "Centre d'aide", pcm: "Help Center", ar: "???? ????????", ff: "Laa?al Ballal" },
  helpCenterDesc:   { en: "Find answers to your questions", fr: "Trouvez des r�ponses � vos questions", pcm: "Find answers here", ar: "???? ?? ?????? ???????", ff: "Yiy jaabaaji ?a??aajamee" },
  faq:              { en: "Frequently asked questions", fr: "Questions fr�quemment pos�es", pcm: "FAQ", ar: "??????? ???????", ff: "?a??aaje heew?e" },
  gettingStarted:   { en: "Getting started", fr: "D�marrer", pcm: "How to start", ar: "?????", ff: "Fu??ude" },
  ...
  safetyHelp:       { en: "Safety & Scams", fr: "S�curit� & Arnaques", pcm: "Safety and Scams", ar: "?????? ?????????", ff: "Kisinaare e Fenaande" },
  technicalHelp:    { en: "Technical issues", fr: "Probl�mes techniques", pcm: "Technical problems", ar: "???????? ???????", ff: "Tuma jii?i" },
  searchHelp:       { en: "Search help", fr: "Aide � la recherche", pcm: "Search help", ar: "?????? ?????", ff: "Ballal yiylaade" },
  wasHelpful:       { en: "Was this helpful?", fr: "Cela vous a-t-il aid�?", pcm: "E help you?", ar: "?? ??? ??? ???????", ff: "?on ballii?" },
  ...
  contactSupportDesc:{ en: "We're here to help � reach out anytime", fr: "Nous sommes l� pour vous aider � contactez-nous � tout moment", pcm: "We dey here to help you anytime", ar: "??? ??? ???????? � ????? ???? ?? ?? ???", ff: "Min ?oo e ballugol � ?an saa'i fof" },
  ...
  messageSent:      { en: "Message sent! We'll reply within 24 hours.", fr: "Message envoy�! Nous r�pondrons dans 24 heures.", pcm: "Message don go! We go reply within 24 hours.", ar: "?? ????? ???????! ???? ???? 24 ????.", ff: "Haala neldiima! Min yettotoo e sahaa 24." },
  liveChat:         { en: "Live chat", fr: "Chat en direct", pcm: "Live chat", ar: "???????? ????????", ff: "Haala hannde" },
  responseTime:     { en: "Average response time: under 2 hours", fr: "D�lai de r�ponse moyen: moins de 2 heures", pcm: "We usually reply in 2 hours", ar: "??? ????????? ???????: ??? ?? ??????", ff: "Yettotoo ko ?uri 2 saate" },

  // -- SAFETY & SECURITY PAGE ---------------------------------------------------
  safetySecurity:   { en: "Safety & Security", fr: "S�curit�", pcm: "Safety & Security", ar: "?????? ????????", ff: "Kisinaare" },
  safetyDesc:       { en: "Your safety is our top priority", fr: "Votre s�curit� est notre priorit� absolue", pcm: "Your safety na our priority", ar: "?????? ?? ???????? ??????", ff: "Kisinaare maa ko wa?i fof" },
  avoidScams:       { en: "How to avoid scams", fr: "Comment �viter les arnaques", pcm: "How to no fall for scam", ar: "????? ???? ????????", ff: "No ha?mi fenaande" },
  reportScam:       { en: "Report a scam", fr: "Signaler une arnaque", pcm: "Report scam", ar: "??????? ?? ????? ??????", ff: "Haald fenaande" },
  securePayments:   { en: "Secure payment tips", fr: "Conseils de paiement s�curis�", pcm: "How to pay safe", ar: "????? ????? ?????", ff: "Yo?de kisinaare" },
  ...
  twoFactor:        { en: "Two-factor authentication", fr: "Authentification � deux facteurs", pcm: "Two-factor authentication", ar: "???????? ????????", ff: "Damal ?i?i" },
  blockedUsers:     { en: "Blocked users", fr: "Utilisateurs bloqu�s", pcm: "Blocked users", ar: "?????????? ?????????", ff: "?e ha?taa" },
  safetyTip:        { en: "Safety tip:", fr: "Conseil de s�curit�:", pcm: "Safety tip:", ar: ":????? ????", ff: "Miijo kisinaare:" },
  ...
  termsTitle:       { en: "Terms & Conditions", fr: "Conditions G�n�rales d'Utilisation", pcm: "Terms and Conditions", ar: "?????? ????????", ff: "Sar?iiji e Golle" },
  ...
  lastUpdated:      { en: "Last updated", fr: "Derni�re mise � jour", pcm: "Last updated", ar: "??? ?????", ff: "Fotnodaa ?enndi" },
  acceptTerms:      { en: "I accept the terms", fr: "J'accepte les conditions", pcm: "I accept am", ar: "???? ??????", ff: "Ja?mii sar?iiji" },
  tableOfContents:  { en: "Table of contents", fr: "Table des mati�res", pcm: "Table of contents", ar: "???? ?????????", ff: "Listu kaa?e" },
  ...
  // -- PRIVACY POLICY PAGE ------------------------------------------------------
  privacyTitle:     { en: "Privacy Policy", fr: "Politique de confidentialit�", pcm: "Privacy Policy", ar: "????? ????????", ff: "Sar?i Gaasooji" },
  privacyDesc:      { en: "How BAMBEH SARL collects and uses your data", fr: "Comment BAMBEH SARL collecte et utilise vos donn�es", pcm: "How Bambeh uses your data", ar: "????? ??? ?????? ???????? ??????????", ff: "No Bambeh wa?i ?atum maa" },
  dataCollected:    { en: "Data we collect", fr: "Donn�es que nous collectons", pcm: "Data we dey collect", ar: "???????? ???? ??????", ff: "?atum min ho?taa" },
  howWeUseData:     { en: "How we use your data", fr: "Comment nous utilisons vos donn�es", pcm: "How we use your data", ar: "????? ????????? ????????", ff: "No wa?mi ?atum maa" },
  dataSharing:      { en: "Data sharing", fr: "Partage des donn�es", pcm: "Data sharing", ar: "?????? ????????", ff: "Wadande ?atum" },
  ...
  dataDeletion:     { en: "Request data deletion", fr: "Demander la suppression des donn�es", pcm: "Request data deletion", ar: "??? ??? ????????", ff: "?a??o sooddi ?atum" },
  privacyContact:   { en: "Privacy questions? Email", fr: "Questions sur la confidentialit�? �crivez �", pcm: "Privacy question? Email", ar: "????? ?? ????????? ???? ?????? ???", ff: "?a??aaje gaasooji? Email" },
  ...
  poweredBy:        { en: "Powered by CamPay � MTN MoMo & Orange Money", fr: "Propuls� par CamPay � MTN MoMo & Orange Money", pcm: "Na CamPay power am � MTN MoMo & Orange Money", ar: "????? ?? CamPay � MTN MoMo ? Orange Money", ff: "CamPay sa?ii � MTN MoMo & Orange Money" },
  mtnOrOrange:      { en: "MTN or Orange phone number", fr: "Num�ro MTN ou Orange", pcm: "MTN or Orange number", ar: "??? MTN ?? Orange", ff: "Nimero MTN walla Orange" },
  ...
  checkPhone:       { en: "Check your phone", fr: "V�rifiez votre t�l�phone", pcm: "Check your phone", ar: "???? ?? ?????", ff: "Yiy Telefon maa" },
  ...
  processing:       { en: "Processing...", fr: "Traitement en cours...", pcm: "E process...", ar: "??? ????????...", ff: "Tii�ude..." },
  paymentConfirmed: { en: "Payment confirmed!", fr: "Paiement confirm�!", pcm: "Payment don confirm!", ar: "?? ????? ?????!", ff: "Yo?de ja??ii!" },
  orderProcessed:   { en: "Your order has been processed", fr: "Votre commande a �t� trait�e", pcm: "Your order don process", ar: "??? ?????? ????", ff: "?a??aade maa wa?aa" },
  payFailed:        { en: "Payment failed", fr: "�chec du paiement", pcm: "Payment fail", ar: "??? ?????", ff: "Yo?de fenaanii" },
  questions:        { en: "Questions?", fr: "Des questions?", pcm: "You get question?", ar: "?? ???? ??????", ff: "?a??aade fof?" },
  securedEncrypted: { en: "Secured & encrypted", fr: "S�curis� & chiffr�", pcm: "Secured and encrypted", ar: "???? ?????", ff: "Kisinaama e ?oggoodaama" },
  orderPlaced:      { en: "Order placed!", fr: "Commande pass�e!", pcm: "Order don place!", ar: "?? ????? ?????!", ff: "?a??aade fu?ii!" },
  payConfirmed:     { en: "Payment confirmed. Your order is on its way.", fr: "Paiement confirm�. Votre commande est en route.", pcm: "Payment confirmed. Your order dey come.", ar: "?? ????? ?????. ???? ?? ??????.", ff: "Yo?de ja??ii. ?a??aade maa arii." },
  ...
  addedBtn:         { en: "Added!", fr: "Ajout�!", pcm: "Added!", ar: "??? ???????!", ff: "Fodaa!" },
  addedToCart:      { en: "Added to cart", fr: "Ajout� au panier", pcm: "Added to cart", ar: "??? ??????? ??? ?????", ff: "Fodaa e paani" },
