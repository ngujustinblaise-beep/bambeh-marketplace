 ...
 * â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
 *
 * âœ… 5 Languages: English, French, Arabic, Hausa, Pidgin (Creole)
...
try {
  ...
  frTranslation = { welcome: "Bienvenue Ã  Bambeh",
    search: "Rechercher",
    login: "Connexion",
    signup: "S'inscrire",
  };
...
try {
  ...
  arTranslation = { welcome: "Ù…Ø±Ø­Ø¨Ø§ Ø¨ÙƒÙ… Ã™ÂÙŠ Ø¨Ø§Ù…Ø¨ÙŠÙ‡",
    search: "Ø¨Ø­Ø«",
 ...
 * 1. en - English (ðŸ‡¬ðŸ‡§)
 * 2. fr - French (ðŸ‡«ðŸ‡·)
 * 3. ar - Arabic (ðŸ‡¸ðŸ‡¦) - RTL
 * 4. ha - Hausa (ðŸ‡³ðŸ‡¬)
 * 5. pcm - Pidgin English (ðŸ‡¨ðŸ‡²) - NEW!
 *
 * Â© 2025 Bambeh. All rights reserved.
 * â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
 */
