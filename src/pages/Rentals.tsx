...
const RENT_T: Record<string, Record<string, string>> = {
  ...
  ar: {
    ...
    "rentals.listProperty": "أضف عقارًا",
    "rentals.refresh": "تحديث",
    "rentals.search": "ابحث بالاسم أو الحي…",
    "rentals.maxRent": "أقصى إيجار",
    "rentals.allCities": "كل المدن",
    "rentals.allTypes": "كل الأنواع",
    "rentals.perMonth": "XAF/شهر",
    "rentals.furnished": "مفروش",
    "rentals.views": "مشاهدات",
    "rentals.view": "مشاهدة",
    "rentals.sampleListing": "مثال — ليس إعلانًا حقيقيًا",
    "rentals.expiringSoon": "ينتهي قريبًا",
    "rentals.propertiesFound": "تم العثور على {{count}} عقار",
    "rentals.loading": "جارٍ تحميل العقارات…",
    "rentals.error": "تعذر تحميل الإعلانات. يتم عرض بيانات تجريبية.",
    "rentals.noPropertiesTitle": "لا توجد عقارات",
    "rentals.noPropertiesHint": "وسّع نطاق عوامل التصفية أو انشر عقارك."
  },
  ff: {
    "rentals.title": "Luwaaji",
    "rentals.listProperty": "Windude suudu",
    "rentals.refresh": "Hesɗitin",
    "rentals.search": "Yiilo innde wala wuro…",
    "rentals.maxRent": "Coggu ɓurtuɗo",
    "rentals.allCities": "Gure fof",
    "rentals.allTypes": "Sifaaji fof",
    "rentals.perMonth": "XAF/lewru",
    "rentals.furnished": "Heeɗaaɗo",
    "rentals.views": "njiyaali",
    "rentals.view": "njiyaa",
    "rentals.sampleListing": "Misal — wonaa bayyinaango goonga",
    "rentals.expiringSoon": "Aray timmude",
    "rentals.propertiesFound": "{{count}} cuuɗi keɓaama",
    "rentals.loading": "Loowugol cuuɗi…",
    "rentals.error": "Roŋki loowude bayyinaali. Hollirde keɓe ndaarɗe.",
    "rentals.noPropertiesTitle": "Cuuɗi alaa",
