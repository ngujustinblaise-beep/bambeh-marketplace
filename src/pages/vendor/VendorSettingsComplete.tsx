...
export default function VendorSettingsComplete() {
  ...
  const renderLanguageSettings = () => (
    <div className="space-y-6">
      <div className="grid sm:grid-cols-2 gap-6">
        {[
          { label: 'Language', key: 'language', options: [['en','English'],['fr','Français'],['ar','العربية'],['ha','Hausa']] },
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
          ...
          <p className="text-xs text-red-400 mt-2">⚠️ Regenerating will invalidate your current key.</p>
        </div>
      </div>
      <div className="border-t border-white/10 pt-6">
        <div className="flex items-center justify-between mb-4">
