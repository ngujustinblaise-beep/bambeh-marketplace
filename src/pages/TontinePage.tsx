...
const T: Record<Lang, {
  ...
  ar: {
    ...
    statMyGroups: "مجموعاتي", statPool: "الصندوق (XAF)", statActive: "نشÙطة",
    tabMy: "مجموعاتي", tabDiscover: "اكتشÙ",
    emptyMyTitle: "لم تنضم إلى أي مجموعة بعد",
    emptyDiscoverTitle: "لا توجد مجموعات مÙتوحة للانضمام الآن",
    emptyMyBody: "أنشئ مجموعة نجانغي خاصة بك وادعÙ أصدقاءك وعائلتك.",
    ...
    secureTitle: "آمن وشÙّار",
    secureBody: "تÙسجَّل جميع معاملات التونتين وتكون مرئية لجميع أعضاء المجموعة على كل الأجهزة.",
    createFab: "إنشاء",
    stOpen: "مÙتوحة", stActive: "نشÙطة", stCompleted: "مكتملة", stPaused: "متوقّÙة",
