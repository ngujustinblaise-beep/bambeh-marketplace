...
const TR: Record<string, Record<Lang, string>> = {
  ...
  clear_filters:     { en: "Clear filters",               fr: "Effacer les filtres",        ha: "Share tace",             ar: "Ù…Ø³Ø­ Ø§Ù„Ã™ÂÙ„Ø§ØªØ±",                  pcm: "Clear filter",            ff: "Æol filters" },
  ...
  sort_price_asc:    { en: "Price: Lowâ†’High",             fr: "Prix: Basâ†’Haut",             ha: "Farashi â†‘",              ar: "Ø§Ù„Ø³Ø¹Ø±: Ù…Ù†Ø®Ã™ÂØ¶â†’Ù…Ø±ØªÃ™ÂØ¹",           pcm: "Price low-high",          ff: "Njaru â†‘" },
  sort_price_desc:   { en: "Price: Highâ†’Low",             fr: "Prix: Hautâ†’Bas",             ha: "Farashi â†“",              ar: "Ø§Ù„Ø³Ø¹Ø±: Ù…Ø±ØªÃ™ÂØ¹â†’Ù…Ù†Ø®Ã™ÂØ¶",           pcm: "Price high-low",          ff: "Njaru â†“" },
  listings_count:    { en: "listings",                    fr: "annonces",                   ha: "jeri",                   ar: "Ø¥Ø¹Ù„Ø§Ù†Ø§Øª",                      pcm: "listing",                 ff: "ndes" },
  in_category:       { en: "in",                          fr: "dans",                       ha: "a cikin",                ar: "Ã™ÂÙŠ",                           pcm: "for",                     ff: "e nder" },
  views:             { en: "views",                       fr: "vues",                       ha: "kallon",                 ar: "Ù…Ø´Ø§Ù‡Ø¯Ø§Øª",                      pcm: "view",                    ff: "yiytatii" },
  negoc:             { en: "Nego.",                       fr: "NÃ©goc.",                     ha: "Ana tattaunawa",         ar: "Ù‚Ø§Ø¨Ù„ Ù„Ù„ØªÃ™ÂØ§ÙˆØ¶",                 pcm: "Nego.",                   ff: "Hewtii" },
  ...
  connection_issue:  { en: "Connection issue",            fr: "ProblÃ¨me de connexion",      ha: "Matsalar hanyar sadarwa",ar: "Ù…Ø´ÙƒÙ„Ø© Ã™ÂÙŠ Ø§Ù„Ø§ØªØµØ§Ù„",             pcm: "Connection problem",      ff: "Juumre naatirde" },
};
...
const CATEGORIES = [
  ...
  { label: "Furniture",   emoji: "ðŸ›‹Ã¯Â¸Â" },
