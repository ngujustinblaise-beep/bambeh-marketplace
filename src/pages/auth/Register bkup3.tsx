      ...
      <div className="w-full max-w-xl">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join Bambeh and start buying, selling, and browsing with confidence.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-8">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700" htmlFor="regEmail">
                Email address
              </label>
              <input
                id="regEmail"
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700" htmlFor="regPass">
                  Password
                </label>
                <input
                  id="regPass"
            ...
            <button
              ...
              className="w-full rounded-xl bg-teal-600 hover:bg-teal-700 disabled:bg-gray-300 text-white py-3 font-semibold transition-colors"
            >
