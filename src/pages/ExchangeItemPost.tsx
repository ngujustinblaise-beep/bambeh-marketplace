/**
 * src/pages/ExchangeItemPost.tsx ó Bambeh Marketplace
 *
...
const STRINGS = {
  en: {
    ...
    addPhoto: 'Add',
    title: 'Title *',
    titlePlaceholder: 'e.g. iPhone 11 ó looking for Samsung Galaxy',
    description: 'Description',
    descPlaceholder: 'Describe your item ó age, features, defects, accessoriesÖ',
    category: 'Category *',
    selectCategory: 'SelectÖ',
    condition: 'Condition *',
    selectCondition: 'SelectÖ',
    location: 'Your Location *',
    locationPlaceholder: 'e.g. YaoundÈ, Bastos',
    wantedLabel: 'What do you want in return?',
    wantedPlaceholder: 'e.g. Samsung Galaxy S21, MacBook AirÖ',
    ...
    infoText: (days: number) => `Your listing will be visible to all Bambeh users. It expires after ${days} days ó you\'ll get a reminder 3 days before.`,
    submit: 'Post Exchange Item',
    posting: 'PostingÖ',
    uploading: (pct: number) => `Uploading photos ${pct}%Ö`,
  ...
  fr: {
    pageTitle: 'Publier pour Èchange',
    freeLabel: 'Gratuit ∑ 30 jours',
    errorTitle: '¿ corriger :',
    photos: 'Photos',
    photosHint: (max: number) => `(jusqu'‡ ${max})`,
    photosPrompt: 'Les photos augmentent vos chances de recevoir des offres',
    addPhoto: 'Ajouter',
    title: 'Titre *',
    titlePlaceholder: 'ex. iPhone 11 ó cherche Samsung Galaxy',
    description: 'Description',
    descPlaceholder: 'DÈcrivez l\'article ó ‚ge, fonctionnalitÈs, dÈfauts, accessoiresÖ',
    category: 'CatÈgorie *',
    selectCategory: 'ChoisirÖ',
    condition: '…tat *',
    selectCondition: 'ChoisirÖ',
    location: 'Votre localisation *',
    locationPlaceholder: 'ex. YaoundÈ, Bastos',
    wantedLabel: 'Que voulez-vous en Èchange ?',
    wantedPlaceholder: 'ex. Samsung Galaxy S21, MacBook AirÖ',
    estValue: 'Valeur estimÈe (FCFA)',
    estValuePlaceholder: 'ex. 150000',
    cashSupplement: 'Accepter un complÈment en espËces ?',
    maxCash: 'ComplÈment max (FCFA)',
    ...
    posting: 'PublicationÖ',
    uploading: (pct: number) => `Envoi photos ${pct}%Ö`,
    errTitle: 'Veuillez entrer un titre.',
    errTitleShort: 'Le titre doit comporter au moins 3 caractËres.',
    errCategory: 'Veuillez sÈlectionner une catÈgorie.',
    errCondition: 'Veuillez sÈlectionner l\'Ètat.',
    errLocation: 'Veuillez entrer votre localisation.',
    errAuth: 'Veuillez vous connecter pour publier.',
    errGeneric: '…chec de la publication. RÈessayez.',
  },
  ha: {
    ...
    photosPrompt: 'Hotuna suna ?ara damar samun tayin',
    addPhoto: '?ara',
    title: 'Taken *',
    titlePlaceholder: 'misali: iPhone 11 ó ina neman Samsung Galaxy',
    description: 'Bayani',
    descPlaceholder: 'Bayyana abin ó tsawon lokaci, halaye, lahani, kayan ha?iÖ',
    category: 'Nau\'i *',
    selectCategory: 'Za?aÖ',
    condition: 'Yanayi *',
    selectCondition: 'Za?aÖ',
    location: 'Wurin ka *',
    locationPlaceholder: 'misali: YaoundÈ, Bastos',
    wantedLabel: 'Me kake so a madadin?',
    wantedPlaceholder: 'misali: Samsung Galaxy S21, MacBook AirÖ',
    estValue: '?imar ku?i (FCFA)',
    estValuePlaceholder: 'misali: 150000',
    cashSupplement: 'Yarda da ?arin ku?i?',
    maxCash: 'Mafi girman ku?in ?ari (FCFA)',
    maxCashPlaceholder: 'misali: 30000',
    infoText: (days: number) => `Za a nuna jerin ku ga duk masu amfani na kwanaki ${days}. Za ku sami tunatarwa kwanaki 3 kafin ?arewa.`,
    submit: 'Buga Abu Don Musanya',
    posting: 'Ana wallafawaÖ',
    uploading: (pct: number) => `Ana aika hotuna ${pct}%Ö`,
    errTitle: 'Shigar da taken.',
    errTitleShort: 'Taken dole ya kasance akalla haruffa 3.',
    errCategory: 'Za?i nau\'in.',
    errCondition: 'Za?i yanayin.',
  ...
  ar: {
    ...
    errorTitle: '???? ???????:',
    photos: '?????',
    photosHint: (max: number) => `(??? ${max})`,
    photosPrompt: '????? ???? ŸÅ??? ŸÅ? ?????? ??? ????',
    addPhoto: '??ŸÅ',
    title: '??????? *',
    titlePlaceholder: '????: ??ŸÅ?? 11 ó ???? ?? ??????? ???????',
    description: '????ŸÅ',
    descPlaceholder: '?ŸÅ ?????? ó ?????? ????????? ??????? ????????Ö',
    category: '??ŸÅ?? *',
    selectCategory: '????Ö',
    condition: '?????? *',
    selectCondition: '????Ö',
    ...
    locationPlaceholder: '????: ??????? ??????',
    wantedLabel: '???? ???? ŸÅ? ????????',
    wantedPlaceholder: '????: ??????? ??????? S21? ??? ??? ???Ö',
    estValue: '?????? ????????? (ŸÅ??? ?ŸÅ????)',
    estValuePlaceholder: '????: 150000',
    cashSupplement: '???? ???? ?????',
    maxCash: '???? ???? ???? ???ŸÅ? (ŸÅ??? ?ŸÅ????)',
    maxCashPlaceholder: '????: 30000',
    infoText: (days: number) => `????? ?????? ????? ??????? Bambeh ???? ${days} ?????. ?????? ??????? ??? 3 ???? ?? ?????? ????????.`,
    submit: '??? ???? ???????',
    posting: '???Ÿç ?????Ö',
    uploading: (pct: number) => `?ŸÅ? ????? ${pct}%Ö`,
    errTitle: '???? ????? ?????.',
    errTitleShort: '??? ?? ????? ??????? ??? 3 ???ŸÅ ??? ?????.',
    errCategory: '???? ?????? ŸÅ??.',
    errCondition: '???? ?????? ??????.',
  ...
  pcm: {
    ...
    addPhoto: 'Add',
    title: 'Title *',
    titlePlaceholder: 'e.g. iPhone 11 ó I wan Samsung Galaxy',
    description: 'Description',
    descPlaceholder: 'Tell am ó how old, wetin dey work, wetin no dey workÖ',
    category: 'Category *',
    selectCategory: 'ChooseÖ',
    condition: 'Condition *',
    selectCondition: 'ChooseÖ',
    location: 'Your Location *',
    locationPlaceholder: 'e.g. YaoundÈ, Bastos',
    ...
    submit: 'Post Exchange Item',
    posting: 'E dey postÖ',
    uploading: (pct: number) => `E dey send photos ${pct}%Ö`,
    errTitle: 'Put title.',
    errTitleShort: 'Title must be at least 3 characters.',
  ...
  ff: {
    ...
    freeLabel: '—aaw?e ∑ —alawma 30',
    errorTitle: 'Waylit:',
    photos: 'Natale',
    photosHint: (max: number) => `(haa ${max})`,
    photosPrompt: 'Natale mbaawi siftinde ja?de',
    addPhoto: 'Ja??it',
    title: 'Innde *',
    titlePlaceholder: 'mis: iPhone 11 ó nji?i Samsung Galaxy',
    description: 'Haalannde',
    descPlaceholder: 'Haalan coftal ó ?oon, maa, baa?e, yoornaaniÖ',
    category: 'Ngolu *',
    selectCategory: 'Su?oÖ',
    condition: 'Ngol *',
    selectCondition: 'Su?oÖ',
    location: 'Wuro maa *',
    locationPlaceholder: 'mis: YaoundÈ, Bastos',
    wantedLabel: 'Ko njijiri na fewtere?',
    wantedPlaceholder: 'mis: Samsung Galaxy S21, MacBook AirÖ',
    estValue: 'Njaru (FCFA)',
    estValuePlaceholder: 'mis: 150000',
    cashSupplement: 'Ja?de kaalis?',
    maxCash: 'Kaalis timmudi (FCFA)',
    maxCashPlaceholder: 'mis: 30000',
    infoText: (days: number) => `Coftaldi maa yiyotoo ko ?ee fof Bambeh Òalawma ${days}. Himo siftina ma Òalawma 3 yesdata.`,
    submit: 'Hollit Coftal Fewtere',
    posting: 'E hollindeÖ',
    uploading: (pct: number) => `E neldinde natale ${pct}%Ö`,
    errTitle: 'Haala innde.',
    errTitleShort: 'Innde ngol ko 3 batu.',
    errCategory: 'Su?o ngolu.',
    errCondition: 'Su?o ngol.',
    errLocation: 'Haala wuro maa.',
    errAuth: 'Naaw yeeso hollirde.',
    errGeneric: 'Hollinde hi?i. He?to katin.',
  },
} as const;
  ...
  if (success) return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="bg-white rounded-2xl shadow p-8 text-center max-w-sm w-full">
        ...
        <p className="text-gray-500 text-sm">Taking you back to exchange listingsÖ</p>
      </div>
    </div>
  );
      ...
      <div className="max-w-lg mx-auto p-4 space-y-4">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 rounded-xl px-4 py-3 text-sm flex items-start gap-2">
            <span className="flex-shrink-0 mt-0.5">?Ô∏è</span>
            <span>{error}</span>
          </div>
        )}
