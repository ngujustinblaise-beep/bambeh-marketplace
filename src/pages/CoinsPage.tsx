/**
 * src/pages/CoinsPage.tsx ó Bambeh Marketplace
 *
 * FIXED (this version):
 *  ? Full i18n via useLang / t() ó EN, FR, Pidgin, Arabic, Fulfulde
...
const strings = {
  ...
  fr: {
    ...
    buyCoins:      'Acheter',
    transfer:      'TransfÈrer',
    tipTitle:      'Gagnez plus de piËces Zerm',
    tipBody:       'Parrainez des amis, complÈtez votre profil et restez actif pour gagner des bonus.',
    historyTitle:  'Historique des transactions',
    all:           'Tout',
    earnedTab:     'GagnÈ',
    spentTab:      'DÈpensÈ',
    noTx:          'Aucune transaction',
    purchased:     'Achat reÁu !',
    purchasedSub:  "Vos piËces peuvent prendre un moment. Appuyez sur Actualiser si nÈcessaire.",
    refresh:       'Actualiser',
    refreshing:    'ActualisationÖ',
  },
  pidgin: {
    title:         'Zerm Coins',
    balance:       'Your Money',
    ...
    tipBody:       'Bring your padis, complete your profile, stay active ó na so bonus dey come.',
    historyTitle:  'Transaction History',
    all:           'All',
    earnedTab:     'You Get',
    spentTab:      'You Spend',
  ...
  fulfulde: {
    ...
    tipBody:       'Naatnu yim?e, he? profil maa, yahugol aktif ó so hono nii mba?aten bonus.',
...
export default function CoinsPage() {
  ...
  const loadData = useCallback(async (isRefresh = false) => {
    ...
    try {
      ...
      // Fetch balance ó maybeSingle() never throws on missing row
      ...
      if (coinData) {
        ...
        // First-time user ó create wallet row
      ...
      <div className="bg-gradient-to-br from-teal-600 to-teal-700 px-4 pt-10 pb-24">
        ...
        <div className="text-center">
          ...
          <div className="text-white text-6xl font-black mb-1">
            {loading ? 'Ö' : (balance ?? 0).toLocaleString()}
          </div>
