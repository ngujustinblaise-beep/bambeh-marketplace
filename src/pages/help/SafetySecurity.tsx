...
const T: Record<string, Record<string, string>> = {
  ...
  "ar": {
    ...
    "scamsDesc": "ØªØ¹Ù„Ù‘Ù… ÙƒÙŠÃ™Â ØªØªØ¹Ø±Ù‘Ã™Â Ø¹Ù„Ù‰ Ø§Ù„Ø¥Ø¹Ù„Ø§Ù†Ø§Øª Ø§Ù„Ø§Ø­ØªÙŠØ§Ù„ÙŠØ© ÙˆØªØªØ¬Ù†Ù‘Ø¨Ù‡Ø§",
    "meetTitle": "Ø§Ù„Ù„Ù‚Ø§Ø¡ Ø¨Ø£Ù…Ø§Ù†",
    "meetDesc": "Ø£Ã™ÂØ¶Ù„ Ø§Ù„Ù…Ù…Ø§Ø±Ø³Ø§Øª Ù„Ù„Ù…Ø¹Ø§Ù…Ù„Ø§Øª Ø§Ù„Ø´Ø®ØµÙŠØ©",
    "reportTitle": "Ø§Ù„Ø¥Ø¨Ù„Ø§Øº Ø¹Ù† Ø§Ù„Ù…Ø´ÙƒÙ„Ø§Øª",
    "reportDesc": "Ø£Ø¨Ù„Øº Ø¹Ù† Ø£ÙŠ Ù†Ø´Ø§Ø· Ø£Ùˆ Ù…Ø­ØªÙˆÙ‰ Ù…Ø´Ø¨ÙˆÙ‡",
    "emergency": "Ø·ÙˆØ§Ø±Ø¦",
    "emergencyMsg": "Ø¥Ø°Ø§ Ø´Ø¹Ø±Øª Ø¨Ø§Ù„ØªÙ‡Ø¯ÙŠØ¯ Ø£Ùˆ Ø¨Ø¹Ø¯Ù… Ø§Ù„Ø£Ù…Ø§Ù†ØŒ Ã™ÂØ§ØªØµÙ„ Ø¨Ø§Ù„Ø³Ù„Ø·Ø§Øª Ø§Ù„Ù…Ø­Ù„ÙŠØ© Ã™ÂÙˆØ±Ù‹Ø§.",
