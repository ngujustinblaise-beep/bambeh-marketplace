...
const T: Record<string, Record<string, string>> = {
  ...
  "ar": {
    ...
    "m3": "Ù…Ø±ÙŠØ­",
    "cashTitle": "Ù†Ù‚Ø¯Ù‹Ø§",
    "cashDesc": "Ø§Ø¯Ã™ÂØ¹ Ø´Ø®ØµÙŠÙ‹Ø§ Ø¹Ù†Ø¯ Ø§Ù„Ù„Ù‚Ø§Ø¡",
    "ca1": "Ø¨Ø¯ÙˆÙ† Ø±Ø³ÙˆÙ… Ù…Ø¹Ø§Ù…Ù„Ø§Øª",
    "ca2": "Ø¯Ã™ÂØ¹ Ã™ÂÙˆØ±ÙŠ",
    "ca3": "Ø¨Ø³ÙŠØ· ÙˆÙ…Ø¨Ø§Ø´Ø±",
    "safetyTitle": "ØªØ°ÙƒÙŠØ± Ø¨Ø§Ù„Ø£Ù…Ø§Ù†",
    "safetyMsg": "Ù„Ø§ ØªØ´Ø§Ø±Ùƒ ØªÃ™ÂØ§ØµÙŠÙ„ Ø§Ù„Ø¯Ã™ÂØ¹ Ø§Ù„Ø®Ø§ØµØ© Ø¨Ùƒ Ù‚Ø¨Ù„ Ø§Ù„Ù„Ù‚Ø§Ø¡ Ø´Ø®ØµÙŠÙ‹Ø§. ØªØ­Ù‚Ù‚ Ø¯Ø§Ø¦Ù…Ù‹Ø§ Ù…Ù† Ø§Ù„Ø³Ù„Ø¹ Ù‚Ø¨Ù„ Ø§Ù„Ø¯Ã™ÂØ¹.",
    ...
    <div dir={isRtl ? "rtl" : "ltr"} className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
          <h3 className="font-bold text-gray-900 mb-3">ðŸ›¡Ã¯Â¸Â {tr("safetyTitle")}</h3>
