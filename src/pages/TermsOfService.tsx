 ...
 *
 * FIXED from original:
 *  - "Republic of ." → "Republic of Cameroon"
 *  - Sections 2 & 3 were completely missing — now added
 *  - Section 4 "ian law" → "Cameroonian law"
 *  - Added all required sections for Play Store / App Store compliance:
 *    account deletion, payment disclosures, AI transparency, user data rights
 *  - Styled to match Bambeh's teal brand
 * ---------------------------------------------------------------------------
 */
...
const SECTIONS: Section[] = [
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1 text-sm text-gray-600">
          ...
          <li>
            Not create more than one personal account. Duplicate accounts may be
            permanently removed.
          </li>
        </ul>
        <p className="mt-3">
        ...
        <p className="mt-1">
          ...
          <strong>Settings → Account</strong> section of the Platform. Upon
          deletion, your personal profile and listings will be removed from public
          view within <strong>30 days</strong>. Certain data may be retained for
          fraud prevention and legal compliance as required by Cameroon law and
          OHADA regulations.
        </p>
      </>
    ),
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 mt-3 space-y-1 text-sm text-gray-600">
          <li>
            All listings must accurately describe the item, service, property, or
            job opportunity, and must comply with all applicable Cameroonian laws.
          </li>
          <li>
            Prices must be stated in <strong>CFA Francs (FCFA)</strong>. Any
            currency other than FCFA must be clearly disclosed.
          </li>
          <li>
            A <strong>1% transaction fee</strong> applies to all completed sales
            processed through Bambeh's payment system — the lowest marketplace
            fee in Cameroon.
          </li>
          <li>
            Payments processed via <strong>CamPay / NotchPay / Mobile Money</strong>{" "}
            (MTN MoMo, Orange Money) are subject to those providers' own terms.
          </li>
          <li>
            Bambeh's escrow feature holds funds securely until both parties confirm
            the transaction is complete.
          </li>
          <li>
            Bambeh does not guarantee the quality, safety, legality, or truth of
            any listing, or the ability of sellers to sell, or buyers to pay.
          </li>
        </ul>
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1 text-sm text-gray-600">
          ...
          <li>
            Human trafficking, forced labor, or any exploitation of persons
          </li>
          <li>
            Child sexual abuse material (CSAM) — violations will be reported
          ...
          <li>
            Hate speech targeting individuals based on ethnicity, religion, gender,
            disability, or sexual orientation
          </li>
          <li>
            Items prohibited under the laws of the Republic of Cameroon or
            applicable international law
          </li>
          <li>
            Spam, pyramid schemes, misleading advertisements, or fraudulent offers
          </li>
          <li>
            Unauthorized collection of other users' personal data
          </li>
        </ul>
        <p className="mt-3">
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          Bambeh operates a virtual rewards currency called{" "}
          <strong>Zerm Coins</strong>. You acknowledge and agree that:
        </p>
        <ul className="list-disc pl-6 mt-2 space-y-1 text-sm text-gray-600">
          <li>
            Zerm Coins have <strong>no monetary value</strong> outside the
            Platform and cannot be exchanged, sold, or transferred for real money
            or goods outside of Bambeh.
          </li>
          <li>
            Zerm Coins are non-transferable to other users (except via the Coins
            Transfer feature within the Platform).
          </li>
          <li>
            Bambeh reserves the right to modify Zerm Coin policies, values, or
            expiry rules with <strong>30 days' written notice</strong> via
            in-app notification or email.
          </li>
          <li>
            Unused Zerm Coins are forfeited upon account deletion.
          </li>
          <li>
            Zerm Coins are granted as platform rewards and are not a financial
            instrument, investment, or cryptocurrency.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1 text-sm text-gray-600">
          <li>
            Pay all fees associated with your chosen subscription plan in FCFA via
            the supported payment methods (MTN MoMo, Orange Money, or other
            CamPay/NotchPay-supported methods).
          </li>
          <li>
            Subscriptions renew automatically unless cancelled at least{" "}
            <strong>24 hours before</strong> the renewal date from your account
            settings.
          </li>
          <li>
            Bambeh does not process payments through Apple In-App Purchases or
            Google Play Billing. All payments are processed externally via
            CamPay/NotchPay mobile money.
          </li>
          <li>
            ...
            within 7 days of a disputed charge.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>
          Bambeh's platform includes AI-powered features including the{" "}
          <strong>Bambeh AI Chatbot</strong>, smart recommendations, and
          search assistance.
        </p>
        <ul className="list-disc pl-6 mt-2 space-y-1 text-sm text-gray-600">
          <li>
            AI responses are generated automatically and may not always be
            accurate. Do not rely solely on AI advice for financial, legal, or
            medical decisions.
          </li>
          <li>
            By using AI features, you consent to your queries being processed
            by our AI service providers in accordance with our{" "}
          ...
          <li>
            Bambeh discloses when you are interacting with an AI system, as
            required under applicable transparency regulations.
          </li>
        </ul>
      </>
    ),
    ...
    body: (
      <>
        <p>
          ...
          Cameroon's <strong>Law No. 2024/017 of 23 December 2024 on Personal
          Data Protection</strong>. You have the right to:
        </p>
        <ul className="list-disc pl-6 mt-2 space-y-1 text-sm text-gray-600">
    ...
    body: (
      <>
        ...
        <p className="mt-3">
          ...
          publicly display, or create derivative works from any part of the
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          To the maximum extent permitted by applicable Cameroonian law:
        </p>
        <ul className="list-disc pl-6 mt-2 space-y-1 text-sm text-gray-600">
          <li>
            Bambeh is not liable for any indirect, incidental, special,
            consequential, or punitive damages arising from your use of the
            Platform, including lost profits or data.
          </li>
          <li>
            Bambeh's total liability to you for any claim arising from these
            Terms shall not exceed the amount you paid to Bambeh in the 3 months
            preceding the claim.
          </li>
          <li>
            Bambeh does not verify the identity of every user and is not
            responsible for any fraudulent activity by third parties. Always
            exercise caution in person-to-person transactions.
          </li>
        </ul>
      </>
    ),
    ...
    body: (
      <>
        <p>
          ...
          Terms or the Platform shall be resolved as follows:
        </p>
        <ol className="list-decimal pl-6 mt-2 space-y-1 text-sm text-gray-600">
          <li>
            <strong>Informal resolution:</strong> First, contact us at{" "}
            <a href="mailto:support@bambeh.com" className="text-teal-600 hover:underline">
              support@bambeh.com
            </a>{" "}
            and we will attempt to resolve the matter within 14 business days.
          </li>
          <li>
            <strong>Arbitration:</strong> If unresolved, disputes shall be
            submitted to binding arbitration in <strong>Yaoundé, Cameroon</strong>,
            under the applicable OHADA Uniform Acts on Arbitration.
          </li>
          <li>
            <strong>Governing law:</strong> These Terms are governed exclusively
            by the laws of the <strong>Republic of Cameroon</strong>.
          </li>
        </ol>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>
          Bambeh may modify these Terms at any time. When we make material changes,
