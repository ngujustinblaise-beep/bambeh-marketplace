...
const SAMPLE_SERVICES: Service[] = [
  { id: 's1', title: 'Professional House Cleaning',      category: 'Cleaning',    price: 15000,  location: 'YaoundÃ©',  description: 'Deep cleaning for homes and offices. All equipment provided.',    created_at: new Date().toISOString(), view_count: 0, isDemo: true, phone: null },
  { id: 's2', title: 'Plumbing Repairs & Installation',  category: 'Plumbing',    price: 25000,  location: 'Douala',   description: 'Expert plumbing â€” pipes, water heaters, taps. Emergency callouts.', created_at: new Date().toISOString(), view_count: 0, isDemo: true, phone: null },
  { id: 's3', title: 'Electrical Services',              category: 'Electrical',  price: 20000,  location: 'YaoundÃ©',  description: 'Wiring, installations, repairs. Licensed electrician.',              created_at: new Date().toISOString(), view_count: 0, isDemo: true, phone: null },
  ...
  { id: 's5', title: 'Photography & Videography',        category: 'Photography', price: 50000,  location: 'YaoundÃ©',  description: 'Events, portraits, commercial photography. Same-day delivery.',     created_at: new Date().toISOString(), view_count: 0, isDemo: true, phone: null },
