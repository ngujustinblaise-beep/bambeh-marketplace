...
const strings = {
  ...
  ar: {
    ...
    infoLine1:      '1 عملة زرم = 100 فرنك CFA',
    infoLine2:      'استخدم العملات لتعزيز إعلاناتك أو إرسال هدايا أو الدفع على المنصة.',
    choosePackage:  'اختر حزمة',
    coins:          'عملات',
    bonus:          'مكافأة',
    total:          'المجموع',
    mostPopular:    'الأكثر شعبية',
    payWith:        'الدفع بالهاتف المحمول',
    buyBtn:         (n: number, price: number) => `شراء ${n} عملة — ${price.toLocaleString()} فرنك`,
    successTitle:   'تم الشراء بنجاح! ⚡',
    addedTo:        'تمت الإضافة إلى محفظتك',
