      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div><Label htmlFor="location">Base Location</Label><Input id="location" name="location" placeholder="e.g., Yaound�, " value={formData.location} onChange={handleInputChange} /></div>
              <div><Label htmlFor="serviceArea">Service Area</Label><Input id="serviceArea" name="serviceArea" placeholder="e.g., Entire Yaound�, or specific neighborhoods" value={formData.serviceArea} onChange={handleInputChange} /></div>
              <div className="flex items-center space-x-2">
