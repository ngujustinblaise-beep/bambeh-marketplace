...
const S: Record<Lang, {
  ...
  ar: {
    ...
    "errImageType": "ÙŠØ±Ø¬Ù‰ Ø§Ø®ØªÙŠØ§Ø± Ù…Ù„Ù ØµÙˆØ±Ø© (JPGØŒ PNGØŒ Ø¥Ù„Ø®).",
    "errImageSize": "ÙŠØ¬Ø¨ Ø£Ù† ØªÙƒÙˆÙ† Ø§Ù„ØµÙˆØ±Ø© Ø£ØµØºØ± Ù…Ù† 5 Ù…ÙŠØºØ§Ø¨Ø§ÙŠØª",
    "photoSuccess": "ØªÙ… ØªØ­Ø¯ÙŠØ« ØµÙˆØ±Ø© Ø§Ù„Ù…Ù„Ù Ø§Ù„Ø´Ø®ØµÙŠ Ø¨Ù†Ø¬Ø§Ø­!",
    "photoFail": "ÙØ´Ù„ Ø±ÙØ¹ Ø§Ù„ØµÙˆØ±Ø©. ÙŠØ±Ø¬Ù‰ Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ø±Ø© Ø£Ø®Ø±Ù‰.",
    "langHint": "Ù‡Ø°Ø§ ÙŠØºÙŠÙ‘Ø± Ù„ØºØ© Ø§Ù„ØªØ·Ø¨ÙŠÙ‚ Ø¨Ø§Ù„ÙƒØ§Ù…Ù„ ÙÙˆØ±Ù‹Ø§.",
    "account": "Ø§Ù„Ø­Ø³Ø§Ø¨",
    ...
    "logoutHint": "ÙŠÙ…ÙƒÙ†Ùƒ ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„ Ù…Ø¬Ø¯Ø¯Ù‹Ø§ Ø¨Ø§Ø³Ù… Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù… Ø£Ùˆ Ø§Ù„Ù‡Ø§ØªÙ Ø£Ùˆ Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ.",
    "notifPrefs": "ØªÙØ¶ÙŠÙ„Ø§Øª Ø§Ù„Ø¥Ø´Ø¹Ø§Ø±Ø§Øª",
    "notif": { "orderUpdates": "ØªØ­Ø¯ÙŠØ«Ø§Øª Ø§Ù„Ø·Ù„Ø¨Ø§Øª", "newMessages": "Ø±Ø³Ø§Ø¦Ù„ Ø¬Ø¯ÙŠØ¯Ø©", "promotions": "Ø§Ù„Ø¹Ø±ÙˆØ¶", "priceAlerts": "ØªÙ†Ø¨ÙŠÙ‡Ø§Øª Ø§Ù„Ø£Ø³Ø¹Ø§Ø±", "systemAlerts": "ØªÙ†Ø¨ÙŠÙ‡Ø§Øª Ø§Ù„Ù†Ø¸Ø§Ù…", "communityPosts": "Ù…Ù†Ø´ÙˆØ±Ø§Øª Ø§Ù„Ù…Ø¬ØªÙ…Ø¹", "newJobs": "ÙˆØ¸Ø§Ø¦Ù Ø¬Ø¯ÙŠØ¯Ø©" },
    "privacyControls": "Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª Ø§Ù„Ø®ØµÙˆØµÙŠØ©",
    "privacy": { "showProfile": "Ø¥Ø¸Ù‡Ø§Ø± Ù…Ù„ÙÙŠ Ø§Ù„Ø´Ø®ØµÙŠ Ù„Ù„Ù…Ø³ØªØ®Ø¯Ù…ÙŠÙ† Ø§Ù„Ø¢Ø®Ø±ÙŠÙ†", "allowListings": "Ø§Ù„Ø³Ù…Ø§Ø­ Ù„Ù„Ø¢Ø®Ø±ÙŠÙ† Ø¨Ø±Ø¤ÙŠØ© Ø¥Ø¹Ù„Ø§Ù†Ø§ØªÙŠ", "showOnline": "Ø¥Ø¸Ù‡Ø§Ø± Ø­Ø§Ù„Ø© Ø§ØªØµØ§Ù„ÙŠ", "allowDM": "Ø§Ù„Ø³Ù…Ø§Ø­ Ø¨Ø§Ù„Ø±Ø³Ø§Ø¦Ù„ Ø§Ù„Ù…Ø¨Ø§Ø´Ø±Ø© Ù…Ù† Ø§Ù„ØºØ±Ø¨Ø§Ø¡" },
