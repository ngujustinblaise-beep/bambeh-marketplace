...
const STR: Record<string, Record<string, string>> = {
  pageTitle:       { en:"Post a Job", fr:"Publier une offre", ha:"Wallafa Aiki", ar:"Ù†Ø´Ø± ÙˆØ¸ÙŠÃ™ÂØ©", pcm:"Post Work", ful:"Fewtu Golle" },
  back:            { en:"Back", fr:"Retour", ha:"Koma", ar:"Ø±Ø¬ÙˆØ¹", pcm:"Go back", ful:"Yahru" },
  subtitle:        { en:"Find the right talent across Cameroon", fr:"Trouvez les meilleurs talents au Cameroun", ha:"Samu gwanin ma'aikata a Kamaru", ar:"Ø§Ø¹Ø«Ø± Ø¹Ù„Ù‰ Ø§Ù„Ù…ÙˆØ§Ù‡Ø¨ Ã™ÂÙŠ Ø§Ù„ÙƒØ§Ù…ÙŠØ±ÙˆÙ†", pcm:"Find correct person for Cameroon", ful:"Yiydaa É—oo e Kameruun" },
  jobTitle:        { en:"Job Title *", fr:"IntitulÃ© du poste *", ha:"Sunan Aiki *", ar:"Ø§Ù„Ù…Ø³Ù…Ù‰ Ø§Ù„ÙˆØ¸ÙŠÃ™ÂÙŠ *", pcm:"Work Name *", ful:"Innde Golle *" },
  ...
  category:        { en:"Job Category *", fr:"CatÃ©gorie *", ha:"Nau'in Aiki *", ar:"Ø§Ù„Ã™ÂØ¦Ø© *", pcm:"Work type *", ful:"Suudu Golle *" },
  jobType:         { en:"Employment Type *", fr:"Type de contrat *", ha:"Nau'in kwantiragi *", ar:"Ù†ÙˆØ¹ Ø§Ù„ØªÙˆØ¸ÙŠÃ™Â *", pcm:"Work arrangement *", ful:"Suudu Kontoraaji *" },
  ...
  isRemote:        { en:"Remote work available", fr:"TÃ©lÃ©travail possible", ha:"Ana iya aiki daga nesa", ar:"ÙŠØªÙˆÃ™ÂØ± Ø¹Ù…Ù„ Ø¹Ù† Ø¨Ã™ÂØ¹Ø¯", pcm:"Online work dey", ful:"E Æanndu É—on" },
  salaryMin:       { en:"Min Salary (FCFA/month)", fr:"Salaire min (FCFA/mois)", ha:"Æ˜aramin albashi (FCFA/wata)", ar:"Ø§Ù„Ø­Ø¯ Ø§Ù„Ø£Ø¯Ù†Ù‰ Ù„Ù„Ø±Ø§ØªØ¨ (Ã™ÂØ±Ù†Ùƒ/Ø´Ù‡Ø±)", pcm:"Small salary (FCFA/month)", ful:"Njobdi bilahi (FCFA/koorka)" },
  ...
  negotiable:      { en:"Salary is negotiable", fr:"Salaire nÃ©gociable", ha:"Albashin ana tattaunawa", ar:"Ø§Ù„Ø±Ø§ØªØ¨ Ù‚Ø§Ø¨Ù„ Ù„Ù„ØªÃ™ÂØ§ÙˆØ¶", pcm:"Salary e fit talk", ful:"Njobdi naggi" },
  ...
  benefits:        { en:"Benefits & Perks", fr:"Avantages et avantages", ha:"Fa'idoji", ar:"Ø§Ù„Ù…Ø²Ø§ÙŠØ§ ÙˆØ§Ù„Ù…ÙƒØ§Ã™ÂØ¢Øª", pcm:"Bonus things", ful:"Nafaaji" },
  benefitsPh:      { en:"Health insurance, transport allowance, bonusesâ€¦", fr:"Assurance maladie, indemnitÃ© de transport, primesâ€¦", ha:"Inshorar lafiya, taimako na sufuri, bonusâ€¦", ar:"ØªØ£Ù…ÙŠÙ† ØµØ­ÙŠØŒ Ø¨Ø¯Ù„ Ù†Ù‚Ù„ØŒ Ù…ÙƒØ§Ã™ÂØ¢Øªâ€¦", pcm:"Health, transport, bonus thingsâ€¦", ful:"Laamu cellal, njuÉ“É“udi, nafaajiâ€¦" },
  ...
  applyMethod:     { en:"How should candidates apply?", fr:"Comment les candidats doivent-ils postuler ?", ha:"Ta yaya masu nema za su yi nema?", ar:"ÙƒÙŠÃ™Â ÙŠØªÙ‚Ø¯Ù… Ø§Ù„Ù…Ø±Ø´Ø­ÙˆÙ†ØŸ", pcm:"How dem go apply?", ful:"No jokkorÉ—e poti jokkude?" },
  ...
  phoneCall:       { en:"ðŸ“ž Phone Call", fr:"ðŸ“ž Appel tÃ©lÃ©phonique", ha:"ðŸ“ž Kiran Waya", ar:"ðŸ“ž Ù…ÙƒØ§Ù„Ù…Ø© Ù‡Ø§ØªÃ™ÂÙŠØ©", pcm:"ðŸ“ž Phone call", ful:"ðŸ“ž Noddaare" },
  ...
  posting:         { en:"Publishing your jobâ€¦", fr:"Publication en coursâ€¦", ha:"Ana wallafa aikinâ€¦", ar:"Ø¬Ø§Ø±Ã™Â Ø§Ù„Ù†Ø´Ø±â€¦", pcm:"Dey post your workâ€¦", ful:"Fewtinaamaâ€¦" },
  posted:          { en:"Job posted successfully!", fr:"Offre publiÃ©e avec succÃ¨s!", ha:"An wallafa aiki cikin nasara!", ar:"ØªÙ… Ù†Ø´Ø± Ø§Ù„ÙˆØ¸ÙŠÃ™ÂØ© Ø¨Ù†Ø¬Ø§Ø­!", pcm:"Your work don post!", ful:"Golle fewtiima!" },
  postBtn:         { en:"Publish Job", fr:"Publier l'offre", ha:"Wallafa Aiki", ar:"Ù†Ø´Ø± Ø§Ù„ÙˆØ¸ÙŠÃ™ÂØ©", pcm:"Post the work", ful:"Fewtu Golle" },
  ...
  loginRequired:   { en:"You must be logged in to post a job", fr:"Vous devez Ãªtre connectÃ© pour publier une offre", ha:"Dole ne ku shiga don wallafa aiki", ar:"ÙŠØ¬Ø¨ ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„ Ù„Ù†Ø´Ø± ÙˆØ¸ÙŠÃ™ÂØ©", pcm:"You need login first", ful:"Naatir ngam fewtoyde golle" },
};
...
const EXP_LEVELS = [
  ...
  { value:"executive",     label:{ en:"Executive", fr:"Cadre dirigeant", ha:"Manajan", ar:"Ù…Ø³Ø¤ÙˆÙ„ ØªÙ†Ã™ÂÙŠØ°ÙŠ", pcm:"Big boss", ful:"Jom Laamu" }},
];
