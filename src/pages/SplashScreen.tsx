...
export default function SplashScreen() {
  ...
  return (
    <div
      dir={isRtl ? 'rtl' : 'ltr'}
      className="min-h-screen bg-gradient-to-br from-teal-600 via-teal-700 to-teal-800 flex flex-col items-center justify-center p-4 relative overflow-hidden"
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-teal-500 rounded-full opacity-20 animate-pulse" />
        <div
          className="absolute -bottom-40 -right-40 w-80 h-80 bg-teal-400 rounded-full opacity-20 animate-pulse"
          style={{ animationDelay: '1s' }}
        />
        <div
          className="absolute top-1/2 left-1/2 w-96 h-96 bg-teal-500 rounded-full opacity-10 animate-pulse -translate-x-1/2 -translate-y-1/2"
      ...
      <div className="relative z-10 animate-fade-in">
        ...
        <div className="w-64 h-2 bg-teal-900 rounded-full overflow-hidden mb-4">
          <div
            className="h-full bg-gradient-to-r from-white to-teal-200 rounded-full transition-all duration-300 ease-out"
            style={{ width: `${progress}%` }}
          />
        </div>

        <p className="text-center text-teal-100 text-sm animate-pulse">
