/**
 * Bambeh Marketplace � D�tails de l'article
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">D�tails de l'article</h1>
          <p className="text-gray-500 mb-6">Informations compl�tes sur cet article.</p>
