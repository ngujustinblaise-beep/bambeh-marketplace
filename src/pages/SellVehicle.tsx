...
const I18N: Record<string, Record<string, string>> = {
  ...
  ar: {
    ...
    pageSubtitle: "ØªÙˆØ§ØµÙ„ Ù…Ø¹ Ø¢Ù„Ø§Ù Ø§Ù„Ù…Ø´ØªØ±ÙŠÙ† ÙÙŠ Ø§Ù„ÙƒØ§Ù…ÙŠØ±ÙˆÙ†",
    back: "Ø§Ù„Ù…Ø±ÙƒØ¨Ø§Øª",
    photos: "Ø§Ù„ØµÙˆØ±",
    photosHint: "Ø£Ø¶Ù Ø­ØªÙ‰ 6 ØµÙˆØ±. Ø§Ù„ØµÙˆØ±Ø© Ø§Ù„Ø£ÙˆÙ„Ù‰ Ù‡ÙŠ Ø§Ù„ØºÙ„Ø§Ù.",
    addPhoto: "Ø¥Ø¶Ø§ÙØ© ØµÙˆØ±Ø©",
    title: "Ø§Ù„Ø¹Ù†ÙˆØ§Ù† *",
    ...
    descPlaceholder: "ØµÙ Ù…Ø±ÙƒØ¨ØªÙƒ â€” Ø§Ù„Ø­Ø§Ù„Ø©ØŒ Ø§Ù„ØªØ§Ø±ÙŠØ®ØŒ Ø§Ù„Ù…Ù…ÙŠØ²Ø§ØªØŒ Ø³Ø¨Ø¨ Ø§Ù„Ø¨ÙŠØ¹â€¦",
    year: "Ø§Ù„Ø³Ù†Ø©",
    ...
    color: "Ø§Ù„Ù„ÙˆÙ†",
    colorPlaceholder: "Ù…Ø«Ø§Ù„: ÙØ¶ÙŠ",
    seats: "Ø§Ù„Ù…Ù‚Ø§Ø¹Ø¯",
    seatsPlaceholder: "Ù…Ø«Ø§Ù„: 5",
    submit: "Ù†Ø´Ø± Ø§Ù„Ø¥Ø¹Ù„Ø§Ù†",
    submitting: "Ø¬Ø§Ø±Ù Ø§Ù„Ù†Ø´Ø±â€¦",
    ...
    manual: "ÙŠØ¯ÙˆÙŠ",
    vehicleDetails: "ØªÙØ§ØµÙŠÙ„ Ø§Ù„Ù…Ø±ÙƒØ¨Ø©",
    contactInfo: "Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ø§ØªØµØ§Ù„ ÙˆØ§Ù„Ù…ÙˆÙ‚Ø¹",
    uploadingImages: "Ø¬Ø§Ø±Ù Ø±ÙØ¹ Ø§Ù„ØµÙˆØ±â€¦",
    imageError: "ÙØ´Ù„ Ø±ÙØ¹ ØµÙˆØ±Ø© ÙˆØ§Ø­Ø¯Ø© Ø£Ùˆ Ø£ÙƒØ«Ø±.",
  },
  pcm: {
