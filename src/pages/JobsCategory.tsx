...
const STR: Record<string, Record<string, string>> = {
  jobs:         { en:"Jobs", fr:"Emplois", ha:"Ayyuka", ar:"وظائف", pcm:"Work", ful:"Golle" },
  opportunity:  { en:"opportunity", fr:"opportunité", ha:"dama", ar:"فرصة", pcm:"opportunity", ful:"sago" },
  opportunities:{ en:"opportunities", fr:"opportunités", ha:"damar aiki", ar:"فرص", pcm:"opportunities", ful:"sagoji" },
  loading:      { en:"Loading", fr:"Chargement", ha:"Ana lodi", ar:"جارٍ التحميل", pcm:"Dey load", ful:"Nannginii" },
  jobs_lc:      { en:"jobs…", fr:"offres…", ha:"ayyuka…", ar:"وظائف…", pcm:"work…", ful:"golle…" },
  ...
  noJobs:       { en:"No jobs posted yet", fr:"Aucune offre publiée", ha:"Babu ayyuka", ar:"لا توجد وظائف بعد", pcm:"No work yet", ful:"Alaa golle" },
  checkBack:    { en:"Check back soon or post one yourself!", fr:"Revenez bientôt ou publiez une offre!", ha:"Dawo cikin wuri ko wallafa aiki!", ar:"عد قريبًا أو انشر وظيفة!", pcm:"Come back later or post work!", ful:"Ardi tuma ɓee ko fewtu!" },
  allJobs:      { en:"All Jobs", fr:"Tous les emplois", ha:"Duk Ayyuka", ar:"جميع الوظائف", pcm:"All Work", ful:"Golle fof" },
  postJob:      { en:"Post a Job", fr:"Publier une offre", ha:"Wallafa Aiki", ar:"نشر وظيفة", pcm:"Post Work", ful:"Fewtu Golle" },
  ...
  loading2:     { en:"Loading…", fr:"Chargement…", ha:"Ana lodi…", ar:"جارٍ التحميل…", pcm:"Dey load…", ful:"Nannginii…" },
  remote:       { en:"Remote", fr:"Télétravail", ha:"Nesa", ar:"عن بُعد", pcm:"Online", ful:"E Ɓanndu" },
