...
const I18N: Record<string, Record<string, string>> = {
  ...
  ar: {
    ...
    browseOther: "تصفح مركبات أخرى",
    vehicleSpecs: "مواصفات المركبة",
    aboutVehicle: "عن هذه المركبة",
    noDesc: "لم يتم تقديم وصف.",
    safetyNote: "افحص المركبة دائمًا شخصيًا وتحقق من وثائق الملكية قبل إجراء أي دفع. لا تتعامل Bambeh مع المدفوعات.",
    noReviews: "(لا توجد تقييمات بعد)",
    callSeller: "اتصل بالبائع",
    whatsapp: "واتساب",
    demoNote: "هذا إعلان تجريبي. أضف مركبتك الخاصة لتظهر هنا.",
    sellVehicle: "بيع مركبة",
    expiringSoon: "ينتهي إعلانك خلال",
    day: "يوم",
    days: "أيام",
    renewHint: "جدده للاستمرار في تلقي الاستفسارات.",
    renewNow: "جدد الآن",
    views: "مشاهدات",
