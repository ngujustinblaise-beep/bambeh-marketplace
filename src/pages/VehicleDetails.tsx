/**
 * src/pages/VehicleDetails.tsx ó Bambeh Marketplace
...
const I18N: Record<string, Record<string, string>> = {
  en: {
    back: "Vehicles",
    loading: "Loading vehicle detailsÖ",
    ...
    saved: "Saved",
    save: "Save",
    whatsappMsg: "Hi, I'm interested in your vehicle listing on Bambeh: \"{title}\" ó {location}. Is it still available?",
  },
  fr: {
    back: "VÈhicules",
    loading: "Chargement des dÈtailsÖ",
    unavailable: "VÈhicule indisponible",
    notFound: "Cette annonce n'a pas pu Ítre trouvÈe.",
    browseOther: "Parcourir d'autres vÈhicules",
    vehicleSpecs: "CaractÈristiques",
    aboutVehicle: "¿ propos de ce vÈhicule",
    noDesc: "Aucune description fournie.",
    safetyNote: "Inspectez toujours le vÈhicule en personne et vÈrifiez les documents de propriÈtÈ avant tout paiement. Bambeh ne gËre pas les paiements.",
    noReviews: "(Aucun avis pour l'instant)",
    callSeller: "Appeler le vendeur",
    whatsapp: "WhatsApp",
    demoNote: "Ceci est une annonce de dÈmonstration. Listez votre propre vÈhicule pour apparaÓtre ici.",
    sellVehicle: "Vendre un vÈhicule",
    ...
    seats: "SiËges",
    colour: "Couleur",
    shareSuccess: "Lien copiÈ dans le presse-papier!",
    sellerInfo: "Vendeur",
    saved: "EnregistrÈ",
    save: "Enregistrer",
    whatsappMsg: "Bonjour, je suis intÈressÈ(e) par votre vÈhicule sur Bambeh: \"{title}\" ó {location}. Est-il encore disponible?",
  },
  ha: {
    back: "Ababen Hawa",
    loading: "Ana loda bayanan abin hawaÖ",
    ...
    saved: "An Ajiye",
    save: "Ajiye",
    whatsappMsg: "Sannu, ina sha'awar abin hawanku akan Bambeh: \"{title}\" ó {location}. Yana nan?",
  },
  ar: {
    back: "????????",
    loading: "???Ÿç ????? ?ŸÅ???? ???????Ö",
    ...
    saved: "??ŸÅ??",
    save: "?ŸÅ?",
    whatsappMsg: "??????? ??? ???? ??????? ??? Bambeh: \"{title}\" ó {location}. ?? ?? ???? ??????",
  },
  pcm: {
    back: "Motors",
    ...
    saved: "Saved",
    save: "Save",
    whatsappMsg: "How far, I dey look your motor for Bambeh: \"{title}\" ó {location}. E still dey?",
  },
  ff: {
    back: "Laa?e",
    loading: "Laa?al njilloyineeÖ",
    ...
    saved: "?ow?aa",
    save: "?ow",
    whatsappMsg: "Jam, mi anndinorii laa?al maa e Bambeh: \"{title}\" ó {location}. ?um ?ii?",
  },
};
