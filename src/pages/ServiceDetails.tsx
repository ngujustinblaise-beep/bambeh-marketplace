...
const STRINGS = {
  en: {
    ...
    safety:        'ðŸ›¡ï¸ Always verify a provider\'s identity before making payment. Bambeh never asks you to pay outside the app.',
    call:          'Call',
  ...
  fr: {
    ...
    safety:        'ðŸ›¡ï¸ VÃ©rifiez toujours l\'identitÃ© d\'un prestataire avant de payer. Bambeh ne demande jamais de payer en dehors de l\'application.',
    call:          'Appeler',
  ...
  ar: {
    ...
    negotiable:    'Ø§Ù„Ø³Ø¹Ø± Ù‚Ø§Ø¨Ù„ Ù„Ù„ØªÙØ§ÙˆØ¶',
    about:         'Ø¹Ù† Ù‡Ø°Ù‡ Ø§Ù„Ø®Ø¯Ù…Ø©',
    provider:      'Ù…Ù‚Ø¯Ù… Ø§Ù„Ø®Ø¯Ù…Ø©',
    more_services: (cat: string) => `Ø§Ù„Ù…Ø²ÙŠØ¯ Ù…Ù† Ø®Ø¯Ù…Ø§Øª ${cat}`,
    safety:        'ðŸ›¡ï¸ ØªØ­Ù‚Ù‚ Ø¯Ø§Ø¦Ù…Ù‹Ø§ Ù…Ù† Ù‡ÙˆÙŠØ© Ø§Ù„Ù…Ø²ÙˆØ¯ Ù‚Ø¨Ù„ Ø§Ù„Ø¯ÙØ¹.',
    call:          'Ø§ØªØµÙ„',
    ...
    report_reasons: ['Ø§Ø­ØªÙŠØ§Ù„','Ø¥Ø¹Ù„Ø§Ù† Ù…Ø²ÙŠÙ','Ù…Ø­ØªÙˆÙ‰ ØºÙŠØ± Ù„Ø§Ø¦Ù‚','ÙØ¦Ø© Ø®Ø§Ø·Ø¦Ø©','Ø³Ø¹Ø± Ù…Ø¶Ù„Ù„','Ø£Ø®Ø±Ù‰'],
  ...
  ha: {
    ...
    safety:        'ðŸ›¡ï¸ Tabbata ainihin mai sabis kafin biyan kuÉ—i.',
    call:          'Kira',
  ...
  pcm: {
    ...
    provider:      'Service Provider',
    more_services: (cat: string) => `More ${cat} services`,
    safety:        'ðŸ›¡ï¸ Always check person before you pay. Bambeh no go ask you pay outside app.',
    call:          'Call',
    book:          'Book Service',
    views:         (n: number) => `${n} view${n !== 1 ? 's' : ''}`,
    verified:      'Verified',
  ...
  ful: {
    ...
    safety:        'ðŸ›¡ï¸ TiiÉ—nu neÉ—É—o hade hade.',
    call:          'Noddu',
