...
export const WELCOME_MESSAGES: Record<string, {
  ...
  ar: {
    greeting:   'Ù…Ø±Ø­Ø¨Ø§Ù‹ Ø¨Ùƒ Ã™ÂÙŠ Bambeh',
    tagline:    'Ø§Ù„ÙƒØ¯Ø­ Ø§Ù„Ø°ÙŠ Ù„Ø§ ÙŠØªÙˆÙ‚Ã™Â',
    subTagline: 'Ø£Ã™ÂØ¶Ù„ Ø³ÙˆÙ‚ Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ Ã™ÂÙŠ Ø§Ù„ÙƒØ§Ù…ÙŠØ±ÙˆÙ† â€” Ø§Ø´ØªØ±Ã™Â ÙˆØ¨ÙŠØ¹ ÙˆØªÙˆØ§ØµÙ„.',
    cta:        'Ø§Ø¨Ø¯Ø£ Ø§Ù„Ø¢Ù†',
  },
};
