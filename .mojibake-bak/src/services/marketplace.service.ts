/**
 * src/services/marketplace.service.ts â€” Bambeh Marketplace
 *
 * REWRITE â€” June 2026
 *
 * FIXES:
 *  âœ… Uses `listings` table (canonical â€” consistent with Marketplace.tsx and MarketplaceItemDetails.tsx)
 *  âœ… increment_view_count RPC passes table_name + record_id
 *  âœ… All CRUD operations use seller_id (not user_id / vendor_id)
 *  âœ… No reference to removed marketplace_items table
 *  âœ… Expiry: listings expire 30 days after creation (stored in expires_at)
 *  âœ… Expiry reminders: getExpiringListings() helper for push notification service
 *
...
// â”€â”€â”€ Read â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
/**
 * Get listings that expire within `withinDays` days â€” used to send expiry reminders.
 */
...
// â”€â”€â”€ View counter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/**
 * Increment view_count for a listing.
 *
 * IMPORTANT: The RPC must receive BOTH `table_name` and `record_id`.
 * The previous version only passed `record_id` â€” this caused the RPC to fail
...
export async function incrementViewCount(id: string): Promise<void> {
  ...
  } catch { /* non-critical â€” view counts are best-effort */ }
}

// â”€â”€â”€ Re-export for backwards compatibility â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
